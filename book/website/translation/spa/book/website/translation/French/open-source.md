...
La plupart des logiciels de recherche les plus utilisés sont les logiciels open source. Peut-être que l'exemple paradigmatique est le paquet Python scikit-learn pour l'apprentissage automatique (Pedregosa et coll. 2011), qui, en l'espace d'un peu plus de cinq ans, a attiré plus de 500 contributeurs uniques, 20 000 contributions individuelles au code et 2 500 citations d'articles. La producción de un paquete comparable en el uso de una aproximación tradicional al código fuente no es probable que no sea refundable. Cela nécessiterait à tout le moins un budget de dizaines de millions de dollars. Tandis que scikit-learn es un surclassement, los centros de otras hojas de código abierto que soportan mejor las especificaciones en el dominio de las contribuciones comunitarias no solidarias; Por ejemplo, el grupo NIPY (neuroimaging in Python) de proyectos en neuroimaging (Gorgolewski y otros. 2016). Notamment, de telles contributions ne se traduisent pas seulement par de nouvelles fonctionnalités dont la communauté au sens large peut bénéficier, mais aussi régulièrement fournir à leurs auteurs respectifs une plus grande reconnaissance de la communauté, et conduire à de nouveaux projets et des opportunités d'emploi.
...
La {ref}`rr-code-reuse` fournit une liste plus approfondie de différents aspects à considérer pour rendre votre code plus réutilisable, que ce soit un petit script ou une bibliothèque.
...
Supposons que vous ayez l'intention pour d'autres personnes de collaborer à votre projet (par opposition à simplement rendre votre code disponible et le considérer comme terminé). Dans ce cas, vous devriez inclure des lignes directrices sur la contribution et, très probablement, un code de conduite.

(rr-open-source-run-guidelines)=
### Directivas de contribución
...
(rr-open-source-contribute-anatomia)=
...
- [Código abierto Vendredi](https://opensourcefriday.com/)
- [Premiers minuteurs uniquement](https://www.firsttimersonly.com/)
- [Triaje de código](https://www.codetriage.com/)
