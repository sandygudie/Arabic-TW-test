...
## Documentar las pruebas y comentar los exámenes
...
- R pruebas unitarias
  - testque
  - tinytest
  - svUnit (función con la interfaz de SciViews)
- Fortran unit-tests:
  - divertido
