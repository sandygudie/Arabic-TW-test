...
(r-test-challenges -difícil-quatify)=
...
- CPPUnit [1] C+++: CPPUNIT_ASSERT_DOUBLES_EQUAL(متوقعس فعلين دلتا)
- اختبار جوجل لـ C++: ASSERT_NEAR(val1, val2, abs_error)
- FRUIT [Fortran: zt_eq_double_in_range_(var1, var2, delta, mensaje)
