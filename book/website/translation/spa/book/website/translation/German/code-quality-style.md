...
Zum Beispiel [PEP8](https://www.python.org/dev/peps/pep-0008/) ist der am weitesten Python-Code-Stil und [ECMAScript 6](http://es6-features.org/) aka [ES6](http://es6-features.org/) ist der ECMA International standardisierte Spezifikation fuer die Programmierung in Javascript.
...
| Jalta         | [Formato Java de Google](https://github.com/google/google-java-format), [JIndent](http://www.jindent.com/)         |
| PHP           | [phpStylist](http://sourceforge.net/projects/phpstylist/)                                                          |
| Perl          | [PerlTidy](http://perltidy.sourceforge.net/)                                                                       |
| Congelar/Bash | [Shelleinzug](http://www.bolthole.com/AWK.html)                                                                    |
...
## Online-Dienste your Qualita®tskontrolle von Software
