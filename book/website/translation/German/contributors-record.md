...
* Rolle: Projektmanager, Tools, Practices & System-Programm, Buch-Dash Mai 2021 Organisationskomitee
* GitHub id: [Arielle-Bennett](http://github.com/Arielle-Bennett)
* ORCID: https://orcid.org/0000-0002-0154-2982

* Kurzbio:
> Ich bin der Projektleiter für Forschungsprojekte für Werkzeuge, Verfahren & Systemprogramm am Alan Turing Institute, eine kritische Rolle der Forschungsinfrastruktur, die eine reibungslose Umsetzung komplexer Kooperationen, Initiativen und einer Gesamtstrategie des Programms sicherstellt. Das Programm konzentriert sich auf die Entwicklung und Verbesserung des kulturellen Wandels, der Forschungsinstrumente und Wissen zur Unterstützung von Open Source, multidisziplinären Arbeiten in der Datenwissenschaft und darüber hinaus. Ich arbeite seit dem Abschluss eines Bachelor-Studiums in Naturwissenschaften in der Forschungsinfrastruktur Das Ergebnis ist eine breite Verständigung über das komplexe Ökosystem der Forschungsveröffentlichung, Start-ups, Community und Projektmanagement. Nach meiner Community Engagement Fellowship 2019 mit dem Center for Scientific Collaboration & Community Engagement, Ich bin ein aktives Mitglied der CSCE-Gemeinschaft, das in ihrem Verhaltenskodex sitzt und die Vielfalt organisiert. Eigenkapital & Inklusion Special Interest Group.

* Persönliche Highlights:
> Bevor ich an der Turing Way teilnahm, wusste ich nicht, was ein Pull-Request war, egal wie man eine macht! Jetzt habe ich zu verschiedenen Teilen der fünf Leitfäden beigetragen, einschließlich der Mitschreibung der ersten Kapitel über [Aktivismus für Forscher](https://the-turing-way.netlify.app/ethical-research/activism.html) und Präsentationen zum Thema auf Konferenzen. Ich unterrichte jetzt auch andere Community-Mitwirkende darüber, wie Pull-Requests erstellt werden können, zu bestehenden Kapiteln beitragen, andere Arbeiten prüfen und neue Ideen entwerfen. Das Buch Dash vom Mai 2021 war eine fantastische Gelegenheit, sich mit der Gemeinschaft zu beschäftigen und sich wieder über das ganze Projekt zu freuen! Ich bin davon abgekommen, mich begeistert und stolz auf die Beiträge, die mit meiner Unterstützung geleistet wurden. Es wird brillant sein zu sehen, wie sich diese in den kommenden Monaten zu Inhalten und Kapiteln entwickeln.

* Persönliches Angebot:
> The Book Dash ist eine unglaubliche Erfahrung sowohl für neuere als auch für etablierte Gemeinschaftsmitglieder. Es ist eine Freude, sich darauf zu konzentrieren, Inhalte für die Turing Way zu entwickeln und Menschen aus der ganzen Welt zu unterstützen. Ich habe das Glück, dass ich im Rahmen des Organisationskomitees eine prominentere Rolle übernehmen und übernehmen konnte.
...
* Kurzbio:
> Ich bin der Gründer von R-Ladies in Saudi-Arabien (Dammam). Ich habe zunächst in der Pharmakologie gedient, aber schnell ein Interesse an Biochemie, Strukturbiologie und Bioinformatik entwickelt. Ich freue mich über die Anwendung eines tiefen Lernens, um biologische Fragen zu beantworten.

* Persönliche Highlights:
> Ich arbeite derzeit an einem Kapitel über "CI Services". Ich habe dabei geholfen, die Jupyter Buchinfrastruktur zu aktualisieren und [Hypothese hinzufügen.is](https://web.hypothes.is/) um eine gemeinsame Anmerkung von _The Turing Way_ Kapiteln zu ermöglichen. Ich habe auch das Kapitel README.me in Arabisch übersetzt. Persönliches Zitat: "Ich finde es schwierig, meine persönlichen Gedanken und Gefühle in Worten zum Ausdruck zu bringen. Das war eine so erstaunliche Erfahrung. Es hat mir geholfen, meine technischen Fähigkeiten zu entwickeln. Vielen Dank an alle, die ich in diesem Buch-Strich-Event :heart: getroffen habe."
...
* Rolle: Buch Dash Mai 2019 Teilnehmer, Übersetzungsleiter - Spanisch (2020)
...
* Rolle: Core-Mitwirkender (2020), [OLS-2 für Turing-Projektleiter](https://github.com/alan-turing-institute/the-turing-way/tree/main/open-life-science-mentoring), Buch Dash November 2020 Teilnehmer
...
* Persönliche Highlights:
> Seit meinem Studienabschluss habe ich in fintech und dann in Kunstorganisationen innerhalb von Personalteams gearbeitet, bis zum Alan Turing Institut und Unterstützung der Ethik-Beratergruppe. Ich denke, mein Highlight ist, dass ich einen großen Hintergrund als Generalistin habe! Ich freue mich derzeit sehr, zusammen mit [Laura Carter](https://github.com/LauraCarter) und [Sophia Batchelor](https://github.com/BrainonSilicon) eine Gemeinschaft um den Leitfaden für ethische Forschung zu gründen! Persönliches Zitat: "Research Ethics is complex and two related concepts are Responsible Research and Innovation (RRI) and Research Integrity. Je nachdem, ob wir einen RRRI-Hut oder eine Forschungs-Integritätsbrille tragen, werden wir auf verschiedene Forschungs-Ethikfragen stoßen. Aber es ist wichtig, diese beiden zu jeder Zeit zu tragen. Ich nenne das Steampunk-Forschungsethiken."

* Weitere Informationen:
> Ich bin wirklich von philosophischen Diskussionen über die Sozialwissenschaften fasziniert so liebe ich den Gedanken zu fragen, wie eine offene Wissenschaftskultur aussieht und wie man dorthin kommt!
...
* Rolle: [OLS-2 für Turing Projektleiter](https://github.com/alan-turing-institute/the-turing-way/tree/main/open-life-science-mentoring), Book Dash November 2020 Teilnehmer
...
* Kurzbio:
> Ich bin Forschungsassistent und Lehrende für Psychologie an der Universität Leicester. Meine wichtigsten Forschungsinteressen betreffen probabilistische Schlussfolgerungen, soziale Hypothesetests und Argumentation von Vorurteilen. Ich bin auch begeistert von der Verbreitung von Wissenschaft und Forschung und interessiere mich für die Reproduzierbarkeit, offene Wissenschaftsthemen und die Schnittstelle zwischen kognitiven und sozialen Aspekten in der Sozialpsychologie.
...
* Rolle: Google Season of Doc: Technical Writer, [OLS-2 für Turing Projektleiter](https://github.com/alan-turing-institute/the-turing-way/tree/main/open-life-science-mentoring)(2020)
...
* Rolle: OLS-2 für Turing Mentor, Book Dash November 2020 Teilnehmer
...
* Rolle: HacktoberFest Spendenförderer, [OLS Projektleiter](https://github.com/alan-turing-institute/the-turing-way/tree/main/open-life-science-mentoring) (2020), Book Dash November 2020 Teilnehmer
...
[all contributors](https://allcontributors.org/) Spezifikation, _Der Turing Way_ erkennt alle Mitwirkenden an, nicht nur diejenigen, die Code schieben. ✨ \n(Mitwirkende)=
## Mitwirkende
...
<td align="center"><a href="https://www.imperial.ac.uk/ict/rcs"><img src="https://avatars3.githubusercontent.com/u/1724545?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Holzbrücke markieren</b></sub></a><br /><a href="#ideas-mwoodbri" title="Ideas, Planning, & Feedback">🤔</a> <a href="#content-mwoodbri" title="Content">🖋</a></td>
...
Dieses Projekt folgt der [Spezifikation für alle Mitwirkenden](https://github.com/all-contributors/all-contributors). Spenden jeder Art willkommen! \n(Mitwirkende)=
# Organisationen und Projekte kooperieren

*Die Turing Way Community erhält Sachspenden von Mitgliedern, die von ihren Arbeitgebern, Projekten oder Organisationen für ihre Teilnahme unterstützt werden. Solche Beiträge sind anwendbar, wenn ein oder mehrere Mitglieder eines Projekts oder einer Organisation zusammenarbeiten, um Ressourcen in The Turing Way zu bauen und zu pflegen. Diese Beiträge umfassen auch Projekte, die auf den Ressourcen von The Turing Way aufbauen oder mit den Teammitgliedern von The Turing Way in verschiedenen Kapazitäten zusammenarbeiten. Wir erkennen jeden dieser Mitwirkenden individuell an und listen seine Profile unter „Kooperative Organisationen und Projekte“ auf.*

## [Technische Universität Delft - Fakultät für angewandte Wissenschaften](https://www.tudelft.nl/en/faculty-of-applied-sciences)

Die Fakultät für Angewandte Wissenschaften ist die größte Universität Delft und konzentriert sich auf die Suche nach innovativen Lösungen für einige der Probleme, vor denen die Gesellschaft steht. Entwicklung des grundlegenden Wissens, das notwendig ist, um technische Entwicklungen zu untermauern, die in der gesamten Gesellschaft weit verbreitet sind. Indem wir sicherstellen, dass dieses Wissen effektiv mit der breiteren Gesellschaft geteilt werden kann die Fakultät legt Wert auf die gemeinsame Nutzung von Daten und Code und verfügt über eine [Forschungsdatenverwaltungsrichtlinie](https://www.tudelft.nl/en/library/research-data-management/r/policies/tu-delft-faculty-policies/) seit 2020. In diesem Bemühen, die Beiträge der Fakultät für Angewandte Wissenschaften haben sich hauptsächlich auf das Reproduzierbare Forschungskapitel von _The Turing Way_ konzentriert.
...
* Kurzbio:
> Ich bin ein Data Steward an der Technischen Universität Delft, der Fakultät für Angewandte Wissenschaften, in den Niederlanden, wo ich Forscher mit ihrem Datenmanagement und offenen wissenschaftlichen Verfahren unterstütze. Für meine Doktorandenforschung habe ich menschliche Zähne für ihre isotopische/chemische Zusammensetzung analysiert, um etwas über menschliche Mobilitätsmuster zu sagen (Felder der Forensik, Archäologie, Osteologie). Neben dem Turing Weg bin ich auch mit anderen Teams beteiligt, wie der [Forschungskalender öffnen](https://openresearchcalendar.org/) ([folgen Sie dem Kalender auf Twitter!](https://twitter.com/OpenResearchCal)), [IsoArcH](https://isoarch.eu/) und ich war ein [OLS3](https://openlifesci.org/ols-3/) Mentor! Ich interessiere mich auch für alles, was mit physikalischen Proben in der Forschung zu tun hat und ich bin Ko-Vorsitzender der [Research Data Alliance Physical Samples Interessengruppe](https://www.rd-alliance.org/groups/physical-samples-and-collections-research-data-ecosystem-ig).

* Persönliche Highlights:
> Dank des Turing Weges habe ich wirklich gelernt, gemeinsam mit GitHub zu arbeiten. Das Buch Strich im Februar 2020 war ein großartiger Anfang, um diese Fähigkeiten tatsächlich zu üben und direkt anzuwenden. was mir jetzt erlaubt, selbstbewusster auch zu anderen Projekten beizutragen! Ich habe in erster Linie zum Reproduzierbaren Forschungskapitel, zum Abschnitt Forschung Data Management beigetragen. Ich habe bereits existierende Inhalte überprüft und arbeite daran, einen Abschnitt über die Datenverwaltungspläne und den Umgang mit personenbezogenen Daten hinzuzufügen. Ich habe auch ein [das Turing Way Poster](https://doi.org/10.5281/zenodo.4263403) erstellt, das ich während einer Konferenz vorgestellt habe. Ich hoffe, es zu bezahlen und anderen zu helfen, zu lernen, wie man mit GitHub durch The Turing Way oder The Carpentries Workshops. Ich bin sehr dankbar, Teil dieser großartigen und inklusiven Community zu sein!

* Weitere Informationen:
> Meines Erachtens sollte die wissenschaftliche Forschung jedem zugänglich sein, der lernen und einen Beitrag leisten möchte. Ich hoffe, Fachleute aus meinem Forschungsbereich zusammenzubringen, um Richtlinien für Isotopische Daten aus menschlichen Überresten und Richtlinien für den Umgang mit und die Dokumentation physischer Proben zu erstellen. Ich bin Ko-Vorsitzender der Research Data Alliance Gruppe [Physical Samples and Collections im Research Data Ecosystem IG](https://www.rd-alliance.org/groups/physical-samples-and-collections-research-data-ecosystem-ig). Bitte nehmen Sie Kontakt auf, wenn Sie mit körperlichen Proben arbeiten und sich daran beteiligen möchten! Ich bin Teil des Open Research Calendar Teams. Dies ist ein Kalender, den Sie nutzen können, um mit offenen Forschungsveranstaltungen auf dem Laufenden zu bleiben oder fügen Sie Ihre eigenen Ereignisse hinzu, um die Sichtbarkeit zu erhöhen. Besuchen Sie uns auf der [Open Research Calendar Website](https://openresearchcalendar.github.io/) oder folgen Sie dem Kalender auf [Twitter](https://twitter.com/OpenResearchCal)!

* Zitat:
> Das Buch Dash im Mai 2021 war für mich eine spannende Gelegenheit, hinter die Kulissen der Organisation zu blicken und Teil eines tollen Teams zu sein. Die Woche selbst war absolut erstaunlich, vor allem die Diskussionen und die "Show and tell" Sitzung!

## [Niederlande eScience Center](https://www.esciencecenter.nl/)

Das niederländische eScience Center ist das nationale Zentrum für die Entwicklung und Anwendung von domänenübergreifender Software und Methoden für die wissenschaftliche Gemeinschaft. Ihr Hauptziel ist es, Wissenschaftlern mit unterschiedlicher Rechenerfahrung die Möglichkeit zu geben, das Potenzial der verfügbaren E-Infrastruktur voll auszuschöpfen und ihnen zu ermöglichen, ansonsten unerreichbare wissenschaftliche Durchbrüche zu erzielen. Das niederländische eScience Center wird hauptsächlich vom nationalen Forschungsrat (NWO) und der nationalen E-Infrastruktur-Organisation (SURF) der Niederlande finanziert.

Das niederländische eScience Zentrum unterhält [seinen eigenen Leitfaden](https://guide.esciencecenter.nl/) für reproduzierbare Softwareentwicklung. Der Fokus des eScience Center-Leitfadens hat eine große Überlappung mit _der Turing Way_ und daher ist es sinnvoll, doppelte Anstrengungen zu vermeiden. Das eScience Center trägt zu _der Turing Way_ in den Bereichen bei, die für den eScience Guide relevant sind. Der eScience Leitfaden verweist auf _den Turing Way_ in dem die Informationen sonst dupliziert werden.

Details zu jedem Mitglied mit seinen Beiträgen sind alphabetisch aufgelistet.

### Carlos Martinez Oritz

* Rolle: **Community Manager**, Book Dash November 2020 Teilnehmer/Helfer
* GitHub id: [c-martinez](http://github.com/c-martinez)
* ORCID: [0000-0001-5565-7577](https://orcid.org/0000-0001-5565-7577)
* Kurzbio:
> Carlos erwarb seinen Doktortitel in Informatik an der University of Exeter. Danach arbeitete er an verschiedenen Forschungsprojekten an der Universität Exeter und der Universität Plymouth. Im eScience Center arbeitete er als Ingenieur in verschiedenen Projekten in den Bereichen digitale Geisteswissenschaften und Biowissenschaften, Entwicklung von Expertise in der Verarbeitung natürlicher Sprachen, vernetzte offene Daten und Software-Nachhaltigkeit. Er ist auch zertifizierter Software-Carpentry Dozent und ist häufig an der Organisation von Schulungen beteiligt.

* Persönliche Highlights:
> Wir setzen uns stets für die Wiederverwendung von Software und die gemeinsame Entwicklung von Software ein. Ich liebe es, dass wir dasselbe für die Richtlinien zur Softwareentwicklung tun können: Inhalte aus dem eScience Guide wiederverwenden und gemeinsam mit _der Turing Way_ Community entwickeln!

* Weitere Informationen:
> Ich bin ein großer Verfechter der Verbesserung der Software-Qualität. Ich bin wirklich froh, dass das eScience Center mit _dem Turing Way_ zusammenarbeitet, um Richtlinien zu erstellen und beim Aufbau besserer Forschungssoftware zu helfen.
...
* Kurzbio:
> Mateusz erwarb an der Jagiellonischen Universität in Krakau seinen Master in Biotechnologie mit Spezialisierung Biophysik. Im September 2019 trat Mateusz dem niederländischen eScience Center in der Rolle des Community Officer mit Schwerpunkt auf Communities und Ausbildung rund um Research Software Engineering, bei Software Best Practices und Nachhaltigkeit, sowie die Rolle von Software in der offenen Wissenschaft und reproduzierbaren Forschung. Seit 2015 ist Mateusz in der Carpentries Community tätig, zuerst als Dozent, später als Mentor, Mitglied des Executive Council und Trainer. Er leitet auch das niederländische Kapitel der Carpentries und ist im Kernteam der nl-RSE-Community.

* Persönliche Highlights:
> Ich habe persönlich an _der Turing Way_ mitgewirkt, indem ich Kapitel im Leitfaden für Reproduzierbare Forschung entworfen habe, prüfte andere Pull Requests und Mentoring-Beiträge vom Netherlands eScience Center.
...
_Die Turing Way_ Teammitglieder und [Redaktionsvorstand des Projekts](https://fairplus.github.io/the-fair-cookbook/content/recipes/boilerplate/people.html), Susanna-Assunta Sansone und Philippe Rocca-Serra, zusammenarbeiten, um eine Interoperabilität zwischen den beiden Ressourcen zu gewährleisten und Erfahrungen als Open-Source-Projektentwickler auszutauschen. FAIR Kochbuch [enthält relevante Kapitel von _Der Turing Weg_](https://fairplus.github.io/the-fair-cookbook/search.html?q=turing+way). In ähnlicher Weise _Der Turing Way_ zeigt das Projekt an und gibt eine Schlaggeschichte mit dem Titel [Von FAIR Co-Autor zu FAIR Doer](https://the-turing-way.netlify.app/reproducible-research/rdm/rdm-stories.html) von Susanna-Assunta Sansone (ein Co-Leiter des FAIR Kochbuch-Projekts). Weitere Details und Hintergründe finden Sie im Kapitel [Das Turing Way Buch](https://fairplus.github.io/the-fair-cookbook/content/recipes/introduction/the-turing-way.html?highlight=turing).
...
* Kurzbio:
> Susanna-Assunta Sansone ist Associate Director und Principal Investigator am Oxford e-Research Centre und Associate Professor am Department of Engineering Science der University of Oxford. Sie ist auch Consultant für Springer Nature und Gründer der Honorarakademie des Wissenschaftlichen Data-Journals.

* Persönliche Highlights:
> TBA

* Weitere Informationen:
> Das Motto von Susanna-Assunta Sanson lautet "Bessere Daten für bessere Wissenschaft". Mit ihrer Gruppe brillanter Forschungssoftware & Wissensingenieure erforscht und entwickelt sie Methoden und Werkzeuge, um die Datenwiederverwendung zu verbessern; Sie arbeiten für Datentransparenz, Forschungsintegrität und die Entwicklung des wissenschaftlichen Publizierens. Darüber hinaus führt sie Forschungsarbeiten durch, um die Forschung zu verbessern und gemeinsam zu arbeiten. Insbesondere ist sie bestrebt, digitale Forschungsobjekte, einschließlich Daten, Findable, Accessible, Interoperable and Reusable, FAIR, für Menschen und für Maschinen zu machen.
...
* Kurzbio:
> Philippe Rocca-Serra promovierte in Molekularbiologie von der Universität Bordeaux, Umzug in den Bereich der Bioinformatik nach dem Beitritt zum Microarray Informatics Team am EMBL-EBI, Cambridge. Dort arbeitete er an der Gründung von ArrayExpress und wurde aktives Mitglied mehrerer Standardisierungsbemühungen, die darauf abzielten, die Vision für offene Daten und offene Wissenschaft zu fördern. Im Rahmen mehrerer EU-Projekte in den Bereichen Toxicogenomik und Nährstoffomik koordinierte er die Entwicklung des ISA-Projekts [1], die nun an der University of Oxford e-Research Centre weitergeführt wird.
...
Unter dem Kooperationsnamen OLS-4 for Turing _arbeitet der Turing Weg_ mit [Open Life Science (OLS)](https://openlifesci.org)zusammen, ein Programm, das Einzelpersonen und Interessengruppen in der Forschung dabei hilft, zu Botschaftern der Open Science zu werden. Dieses Programm wurde von Be<unk> re<unk> nice Batut, Malvika Sharan und Yo Yehudi mitbegründet. Diese Zusammenarbeit bietet interessierten Mitgliedern aus Turing und The Turing Way Communities Schulung und Mentoring an, um dem OLS-Programm individuell oder in Teams beizutreten. Sie entwickeln Open Science Aspekte in den Projekten, an denen sie entweder bereits gearbeitet haben oder die sie in naher Zukunft entwickeln wollen.

Sie können die Projekte sehen, die an der zweiten Runde teilgenommen haben - [OLS-2](https://openlifesci.org/ols-2/projects-participants/) und die dritte Runde - [OLS-3](https://openlifesci.org/ols-3/projects-participants/). Diese Zusammenarbeit wurde mit dem Zuschuss für Turing Online Training zur Unterstützung von Turing-Projekten in der vierten Runde ([OLS-4](https://openlifesci.org/funders)) ausgezeichnet und Materialien offen im Turing-Ausbildungsnetz freigegeben.

## [Remote Computational Project Ressource](https://isabelbirds.github.io/Remote-Computational-Project-Resource/welcome.html)

Diese Ressource wurde von Isabel Birds während der COVID-19 Pandemie gestartet, um Studenten zu unterstützen, die kurzfristig von feuchten in entfernte Trockenlabors überführt wurden. Dieses Projekt enthält Links zu (1) allgemeinen Tutorials für den kompletten Anfänger, (2) Tutorials für spezifische Analysen oder Pipelines, (3) kostenlose Online-Lehrbücher und (4) Orte, um Hilfe zu bitten.
...
* Kurzbio:
> Isabel ist Doktorkandidat an der Universität von Leeds und arbeitet an der Zersplitterung der Funktion und der molekularen Evolution von lang nicht codierenden RNAs unter der Aufsicht von Dr. Julie Aspden, Dr. Mary J O’Connell und Dr. David Westhead. Sie hat sich für die molekulare Evolution und die Anwendung bioinformatischer Techniken während ihres Studiums interessiert. und entwickelte diese Interessen während der Durchführung von Forschungsprojekten im Labor Aspden und O’Connell.  
> Sie hat auch Erfahrung in der wissenschaftlichen Forschung aus der Perspektive der Geldgeber Während ihres Jahres in der Industrie und zahlreichen Sommerpraktika bei Yorkshire Cancer Research.

* Persönliche Highlights:
> Nach dem Lernen über die Turing Way wurde ich inspiriert eine Website für ein breiteres Publikum zu erstellen. Die Turing Way Tutorials haben mir geholfen, mein erstes Jupyter Buch zu erstellen, hat mir geholfen, die Website in einer Art und Weise zu erstellen, die offen für Beiträge ist, und machte den Austausch meiner Arbeit weniger beängstigend! Der Turing Way taucht auch ein paar Mal in den aufgelisteten Ressourcen auf. Das Ziel der Ressource ist es, den Start eines Rechenprojekts durch die Kuratierung von Links zu Tutorials und Online-Lehrbüchern weniger überwältigend zu machen. Hervorheben werden auch Fähigkeiten wie Dateimanagement oder effektiv um Hilfe gebeten zusammen mit unterhaltsamen Dingen wie Podcasts als Erinnerung daran, dass Forschung Spaß machen kann!
