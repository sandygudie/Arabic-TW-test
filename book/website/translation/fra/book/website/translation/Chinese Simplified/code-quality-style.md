...
| 语言            | 格式化工具                                                                                                            |
| ------------- | ---------------------------------------------------------------------------------------------------------------- |
| C/C++         | [GNUIndent](http://www.gnu.org/software/indent/), [Code supérieur](http://sourceforge.net/projects/gcgreatcode/) |
...
| Obus / Frappe | [Obus](http://www.bolthole.com/AWK.html)                                                                         |
...
```
"editor.<unk> <unk> <unk> OnSave"：vrai,
```
