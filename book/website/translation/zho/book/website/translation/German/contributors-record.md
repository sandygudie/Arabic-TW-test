...
* Kurzbio:
> Ich bin fud hrend bei Tools, Practices and Systems Research Programmen am Alan Ting Institute. Cambridge University of Cambridge in Brain Mapping Unit durchgefutidowershrt. Ich habe einen Doktortitel in Neurowissenschaften an der University of California in Berkeley und habe meine Postdoktorenforschung an der University of Cambridge in the Brain Mapping Unit durchgefutiputs. Ich bin Mozilla-Stipendiat (2016) und Fulbright Stipendiat (2007) Alumna.
...
* Kurzbio:
> Ich bin ein Mozilla Fellow (2018) und Doktoranden an der MRC Brain Network Dynamics Unit an der University of Oxford (2015-). Ich erhalte auch Unterstutients tzung vom Program软件可持续研究所研究金(2018) und Microsoft/Research Software England Cloud Computing Fellowshellows Program(2018). 牛津大学医学研究室战争（2012-2015年）。

* Persointing nliches Highlight:
...
* Kurzbio:
> Alejandro hat im September 2020 seine Doktorarbeit in Physical Geography am King's College London abgeschlossen Derzeit arbeitet er als Postdoctoral Research Associate am Alan Turing Institute an einem Projekt mit dem Ziel, Open-Source-Toolkits und Demonstranten für Umweltdatenwissenschaft zu bauen und einzusetzen. Er trägt auch zu `Scivision`bei, ein generisches Framework für skalierbare Bildanalyse, geleitet von der Turing in Zusammenarbeit mit der Open-Source-Community.
...
* Kurzbio:
> 谢菲尔德大学Ich bin Forschungs-Software-Ingenieur。 Ich bin auch ein Editor für rOpenSci, eine Gemeinschaft von Benutzern und Entwicklern, Schaffung einer technischen Infrastruktur für Peer-Review-R-Software-Tools für die Zusammenarbeit mit wissenschaftlichen Datenquellen im Internet.
...
* Kurzbio:
> Ich bin Doktorand am King's College London (creinfsichtigt von Dr. Petroula Proitsi & Professor Marcus Richards) und Engage Student am The Alan Ting Institute. Mein Doktorandenprojekt zielt darauf ab, frühe Mechanismen und biologische Marker von Demenz zu identifizieren, und ich arbeite derzeit auch am DECOVID Projekt am Institut.
...
* Kurzbio:
> Ich bin Research Data Scientist am Alan Ting Institute. Ich habe an der Universidad Paris Diderot promovier, wo ich am ATLAS-Experiment am large Hadron Collider in CERN arbeitete. Während meiner Doktorarbeit habe ich an der Entdeckung der Higgs Boson-Partikel teilgenommen, die 2012 von CERN angekündigt wurde. Ich arbeitete weiter an ATLAS als Postdoc an der Uppsala Universität, wo ich mich auf die Suche nach Physik jenseits des Standardmodells der Teilchenphysik konzentrierte. Vor meinem Eintritt in die Turing war ich als Data Scientist im EdTech-Sektor tätig und habe innovative Produkte entwickelt, die sich auf den Bewertungsprozess in der Ausbildung konzentrieren. Zusammenarbeit的Derzeit arbeit mit Forschern des Global Systems Institute a der University of Exeter namens Data Science for Sustainable Development. In diesem Projekt verwenden wir Fernerkundung, um die Widerstandsfähigkeit der gemusterten Vegetation von halbtrockenen Trockenökosystemen in der Sahel zu überwachen.
...
* Kurzbio:
> Ich bin Ethik-Forschungsassistent am Alan Ting Institute. Ich habe ein BSc in Business Management und Administration und arbeite derzeit an einem MSc in der Philosophie der Sozialwissenschaften. Ich bin Mitglied des Chartered Institute of Personnel and Development (CIPD).

* Persoche nliche 高亮：
> Seit meinem Studienabschluss habe ich in fintech und dann in Kunstorganisationen innerhalb von Personalteams gearbeitet, bis zum Alan Turing Institut und Unterstützung der Ethik-Beratergruppe. Ich denke, mein Highlight ist, dass ich einen großen Hintergrund als Generalistin habe! Ich freue mich derzeit sehr, zusammen mit [Laura Carter](https://github.com/LauraCarter) und [Sophia Batchelor](https://github.com/BrainonSilicon) eine Gemeinschaft um den Leitfaden für ethische Forschung zu gründen! Persointing nliches Zitat：“研究伦理学很复杂，两个相关的概念是负责任的研究和创新（RRI）和研究的正直性。 Je nachdem, ob wir einen RRRI-Hut oder eine Forschungs-Integritätsbrille tragen, werden wir auf verschiedene Forschungs-Ethikfragen stoßen. Aber es ist wichtig, diese beiden zu jeder Zeit zu tragen. Ich nenne das Steampunk-Forschungsethiken."
...
* Persoche nliche 高亮：
> 我非常喜欢围绕着“光辉道路”来聚会如此热情和充满活力的社区！ Ich habe hauptsächlich dazu beigetragen, offene Pull Requests und Netzwerke mit den Community-Mitgliedern zu prüfen.
...
* 角色： 核心贡献者（2019年），2020年2月Dash书帮助者
* GitHub id: [LouiseABowler](http://github.com/LouiseABowler)
* ORCID: [0000-0002-4910-9205](https://orcid.org/0000-0002-4910-9205)
* Kurzbio:
> Ich bin Research Data Scientist in der Research Engineering Group des Alan Ting Institute. Ich habe einen Abschluss in Physik am Imperial College London, danach trat ich in das Life Sciences Interface Doktorausbildungszentrum der Universidad Oxford ein. Ich arbeitete an einem interdisziplinären Doktorandenprojekt, das mathematische Modellierung, Herzphysiologie und Sicherheits-Pharmakologie kombinierte und anschließend zur Turing überging. Seitdem habe ich an einer Reihe von Projekten gearbeitet, die synthetische Daten, Datenvisualisierung und natürlich den Turing Way umfassen!
...
* Rolle: Core contributor, JupyterBook Infrastructure 维护者 (202020), OLS-2 for Turing guidor, Book Dash 2020 Teilnehmer und Helfer
...
* 角色: Google Season of Doc: Technical Writer, [OLS-2 fuIndustriers Ting Projektleiter](https://github.com/alan-turing-institute/the-turing-way/tree/main/open-life-science-mentoring)(2020)
...
* 角色： OLS-2 futir Tinging Mentor, Book Dash 2020 Teilnehmer
...
(Mitwirkende)=
# Alle Mitwirkenden
✨Benutze [alle Mitwirkenden](https://allcontributors.org/) Spezifikation, _der Turing Way_ erkennt alle Mitwirkenden, nicht nur diejenigen, die Code schieben. ✨ (贡献者-记录贡献者) =
...
<td align="center"><a href="http://beckigreen.netlify.app"><img src="https://avatars.githubusercontent.com/u/77735779?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Becki GruIndividun</b></sub></a><br /><a href="#ideas-beckigreen" title="Ideas, Planning, & Feedback">🤔</a> <a href="#content-beckigreen" title="Content">:inventain_pen:</a></td>
<td align="center"><a href="https://github.com/r-j-arnold"><img src="https://avatars1.githubusercontent.com/u/20441134?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Becky Arnold</b></sub></a><br /><a href="#question-r-j-arnold" title="Answering Questions">:speech_ballon:</a> <a href="https://github.com/alan-turing-institute/the-turing-way/commits?author=r-j-arnold" title="Code">:laptop_compute:</a> <a href="https://github.com/alan-turing-institute/the-turing-way/commits?author=r-j-arnold" title="Documentation">📖</a> <a href="#ideas-r-j-arnold" title="Ideas, Planning, & Feedback">🤔</a> <a href="https://github.com/alan-turing-institute/the-turing-way/pulls?q=is%3Apr+reviewed-by%3
b></sub></a><br /><a href="https://github.com/alan-turing-institute/the-turing-way/issues?q=author%3Aleavanh" title="Bug reports">🐛</a></td>
...
<tr>
<td align="center"><a href="https://github.com/msanter01"><img src="https://avatars0.githubusercontent.com/u/39199660?v=4?s=100" width="100px;" alt=""/><br /><sub><b>msanter01</b></sub></a><br /><a href="#translation-msanter01" title="Translation">🌍</a> <a href="#talk-msanter01" title="Talks">:Lautsprecher:</a></td>
...
Dieses Projekt folgt der [Spezifikation für alle Mitwirkenden](https://github.com/all-contributors/all-contributors). Spenden jeder Art willkommen! \n(Mitwirkende)=
# Organisationen und Projekte kooperieren

*Die Turing Way Community erhält Sachspenden von Mitgliedern, die von ihren Arbeitgebern, Projekten oder Organisationen für ihre Teilnahme unterstützt werden. Solche Beiträge sind anwendbar, wenn ein oder mehrere Mitglieder eines Projekts oder einer Organisation zusammenarbeiten, um Ressourcen in The Turing Way zu bauen und zu pflegen. Diese Beiträge umfassen auch Projekte, die auf den Ressourcen von The Turing Way aufbauen oder mit den Teammitgliedern von The Turing Way in verschiedenen Kapazitäten zusammenarbeiten. Wir erkennen jeden dieser Mitwirkenden individuell an und listen seine Profile unter „Kooperative Organisationen und Projekte“ auf.*

## [Technische Universität Delft - Fakultät für angewandte Wissenschaften](https://www.tudelft.nl/en/faculty-of-applied-sciences)

Die Fakultät für Angewandte Wissenschaften ist die größte Universität Delft und konzentriert sich auf die Suche nach innovativen Lösungen für einige der Probleme, vor denen die Gesellschaft steht. Entwicklung des grundlegenden Wissens, das notwendig ist, um technische Entwicklungen zu untermauern, die in der gesamten Gesellschaft weit verbreitet sind. Indem wir sicherstellen, dass dieses Wissen effektiv mit der breiteren Gesellschaft geteilt werden kann die Fakultät legt Wert auf die gemeinsame Nutzung von Daten und Code und verfügt über eine [Forschungsdatenverwaltungsrichtlinie](https://www.tudelft.nl/en/library/research-data-management/r/policies/tu-delft-faculty-policies/) seit 2020. In diesem Bemühen, die Beiträge der Fakultät für Angewandte Wissenschaften haben sich hauptsächlich auf das Reproduzierbare Forschungskapitel von _The Turing Way_ konzentriert.

### Esther Plomp

* 滚刀：
  * Book Dash Februar 2020 Teilnehmer
  * Buchprüfungsausschuss 2021
  * Autcomef Absturz
...
* Kurzbio:
> Ich bin ein Data Steward an der Technischen Universität Delft, der Fakultät für Angewandte Wissenschaften, in den Niederlanden, wo ich Forscher mit ihrem Datenmanagement und offenen wissenschaftlichen Verfahren unterstütze. Für meine Doktorandenforschung habe ich menschliche Zähne für ihre isotopische/chemische Zusammensetzung analysiert, um etwas über menschliche Mobilitätsmuster zu sagen (Felder der Forensik, Archäologie, Osteologie). Neben dem Turing Weg bin ich auch mit anderen Teams beteiligt, wie der [Forschungskalender öffnen](https://openresearchcalendar.org/) ([folgen Sie dem Kalender auf Twitter!](https://twitter.com/OpenResearchCal)), [IsoArcH](https://isoarch.eu/) und ich war ein [OLS3](https://openlifesci.org/ols-3/) Mentor! Ich interestsiere mich auch fuch fur all 曾经在 der Forschung zu tun hat und ich bin Ko-Vorsitzender [研究数据联盟物理采样师](https://www.rd-alliance.org/groups/physical-samples-and-collections-research-data-ecosystem-ig) 中进行了理性研究。

* Persoche nliche 高亮：
> Dank des Turing Weges habe ich wirklich gelernt, gemeinsam mit GitHub zu arbeiten. Das Buch Strich im Februar 2020 war ein großartiger Anfang, um diese Fähigkeiten tatsächlich zu üben und direkt anzuwenden. was mir jetzt erlaubt, selbstbewusster auch zu anderen Projekten beizutragen! Ich habe in erster Linie zum Reproduzierbaren Forschungskapitel, zum Abschnitt Forschung Data Management beigetragen. Ich habe bereits existierende Inhalte überprüft und arbeite daran, einen Abschnitt über die Datenverwaltungspläne und den Umgang mit personenbezogenen Daten hinzuzufügen. Ich habe auch ein [das Turing Way Poster](https://doi.org/10.5281/zenodo.4263403) erstellt, das ich während einer Konferenz vorgestellt habe. Ich hoffe, es zu bezahlen und anderen zu helfen, zu lernen, wie man mit GitHub durch The Ting Way ooder The Carpentes Workshop Ich bin sehr dankbar, Teil dieser großartigen und inklusiven Community zu sein!

* Weitere Informationen:
> Meines Erachtens sollte die wissenschaftliche Forschung jedem zugänglich sein, der lernen und einen Beitrag leisten möchte. Ich hoffe, Fachleute aus meinem Forschungsbereich zusammenzubringen, um Richtlinien für Isotopische Daten aus menschlichen Überresten und Richtlinien für den Umgang mit und die Dokumentation physischer Proben zu erstellen. Ich bin Ko-Vorsitzender Research Data Alliance Gruppe [物理样本和收藏品包含研究数据生态系统IG](https://www.rd-alliance.org/groups/physical-samples-and-collections-research-data-ecosystem-ig)。 Bitte nehmen Sie Kontakt auf, wenn Sie mit körperlichen Proben arbeiten und sich daran beteiligen möchten! Ich bin Teil des Open Research Calendar Teams. Dies ist ein Kalender, den Sie nutzen können, um mit offenen Forschungsveranstaltungen auf dem Laufenden zu bleiben oder fügen Sie Ihre eigenen Ereignisse hinzu, um die Sichtbarkeit zu erhöhen. Besuchen Sie uns auf der [Open Research Calendar Website](https://openresearchcalendar.github.io/) oder folgen Sie dem Kalender auf [Twitter](https://twitter.com/OpenResearchCal)!

* Zitat:
> Das Buch Dash im Mai 2021 war für mich eine spannende Gelegenheit, hinter die Kulissen der Organisation zu blicken und Teil eines tollen Teams zu sein. Die Woche selbst war absolut erstaunlich, vor allem die Diskussionen und die "Show and tell" Sitzung!

## [Niederlande eScience Center](https://www.esciencecenter.nl/)

Das niederländische eScience Center ist das nationale Zentrum für die Entwicklung und Anwendung von domänenübergreifender Software und Methoden für die wissenschaftliche Gemeinschaft. Ihr Hauptziel ist es, Wissenschaftlern mit unterschiedlicher Rechenerfahrung die Möglichkeit zu geben, das Potenzial der verfügbaren E-Infrastruktur voll auszuschöpfen und ihnen zu ermöglichen, ansonsten unerreichbare wissenschaftliche Durchbrüche zu erzielen. Das niederländische eScience Center wird hauptsächlich vom nationalen Forschungsrat (NWO) und der nationalen E-Infrastruktur-Organisation (SURF) der Niederlande finanziert.

Das niederländische eScience Zentrum unterhält [seinen eigenen Leitfaden](https://guide.esciencecenter.nl/) für reproduzierbare Softwareentwicklung. Der Fokus des eScience Center-Leitfadens hat eine große Überlappung mit _der Turing Way_ und daher ist es sinnvoll, doppelte Anstrengungen zu vermeiden. Das eScience Center trägt zu _der Turing Way_ in den Bereichen bei, die für den eScience Guide relevant sind. Der eScience Leitfaden verweist auf _den Turing Way_ in dem die Informationen sonst dupliziert werden.

Details zu jedem Mitglied mit seinen Beiträgen sind alphabetisch aufgelistet.

### Carlos Martinez Oritz

* 角色： **社区管理器**, 书籍Dash November 2020 Teilnehmer/Helfer
* GitHub id: [c-martinez](http://github.com/c-martinez)
* ORCID: [0000-0001-5565-7577](https://orcid.org/0000-0001-5565-7577)
* Kurzbio:
> Carlos erwarb seinen Doktortel in Informatik an der University of Exeter. Danach arbeitete er an verschiedenen Forschungsprojekten an der Universität Exeter und der Universität Plymouth. Im eScience Center arbeitete er als Ingenieur in verschiedenen Projekten in den Bereichen digitale Geisteswissenschaften und Biowissenschaften, Entwicklung von Expertise in der Verarbeitung natürlicher Sprachen, vernetzte offene Daten und Software-Nachhaltigkeit. Er ist auch zertifizierter Software-Carpentry Dozent und ist häufig an der Organisation von Schulungen beteiligt.

* Persoche nliche 高亮：
> Wir setzen uns stets für die Wiederverwendung von Software und die gemeinsame Entwicklung von Software ein. Ich liebe es, dass wir dasselbe für die Richtlinien zur Softwareentwicklung tun können: Inhalte aus dem eScience Guide wiederverwenden und gemeinsam mit _der Turing Way_ Community entwickeln!

* Weitere Informationen:
> Ich bin ein großer Verfechter der Verbesserung der Software-Qualität. Ich bin wirklich froh, dass das eScience Center mit _dem Turing Way_ zusammenarbeitet, um Richtlinien zu erstellen und beim Aufbau besserer Forschungssoftware zu helfen.
...
* Kurzbio:
> Mateusz erwarb an der Jagiellonischen Universität in Krakau seinen Master in Biotechnologie mit Spezialisierung Biophysik. Im September 2019 trat Mateusz dem niederländischen eScience Center in der Rolle des Community Officer mit Schwerpunkt auf Communities und Ausbildung rund um Research Software Engineering, bei Software Best Practices und Nachhaltigkeit, sowie die Rolle von Software in der offenen Wissenschaft und reproduzierbaren Forschung. Seit 2015 ist Mateusz in der Carpentries Community tätig, zuerst als Dozent, später als Mentor, Mitglied des Executive Council und Trainer. Er leitet auch das niederländische Kapitel der Carpentries und ist im Kernteam der nl-RSE-Community.

* Persoche nliche 高亮：
> Ich habe persönlich an _der Turing Way_ mitgewirkt, indem ich Kapitel im Leitfaden für Reproduzierbare Forschung entworfen habe, prüfte andere Pull Requests und Mentoring-Beiträge vom Netherlands eScience Center.

## [FAIR Kochbuch](https://fairplus.github.io/the-fair-cookbook/content/home.html)

FAIR Cookbook ist eine Online-Ressource, die Forschern und Datenmanagern hilft, ihre Daten Findable, Accessible, Interoperable und Reusable (FAIR) zu erstellen. FAIRPlus Cookbook baut auf _der Turing Way_ Projekt- und Gemeinschaftsmodellen auf, und bietet Kapitel als "Rezepte" nach den FAIR-Elementen, Publikumstyp, Lese-Zeit und Schwierigkeitsgrad.

_Die Turing Way_ Teammitglieder und [Redaktionsvorstand des Projekts](https://fairplus.github.io/the-fair-cookbook/content/recipes/boilerplate/people.html), Susanna-Assunta Sansone und Philippe Rocca-Serra, zusammenarbeiten, um eine Interoperabilität zwischen den beiden Ressourcen zu gewährleisten und Erfahrungen als Open-Source-Projektentwickler auszutauschen. FAIR Kochbuch [enthält relevante Kapitel von _Der Turing Weg_](https://fairplus.github.io/the-fair-cookbook/search.html?q=turing+way). In ähnlicher Weise _Der Turing Way_ zeigt das Projekt an und gibt eine Schlaggeschichte mit dem Titel [Von FAIR Co-Autor zu FAIR Doer](https://the-turing-way.netlify.app/reproducible-research/rdm/rdm-stories.html) von Susanna-Assunta Sansone (ein Co-Leiter des FAIR Kochbuch-Projekts). Weitere Details und Hintergründe finden Sie im Kapitel [Das Turing Way Buch](https://fairplus.github.io/the-fair-cookbook/content/recipes/introduction/the-turing-way.html?highlight=turing).

### Susanna-Assunta Sansone

* Rolle: Book Dash Mai 2019 Teilnehmer
* GitHub id: [susannasansone](http://github.com/susannasansone)
* ORCID: [0000-0001-5306-5690](https://orcid.org/0000-0001-5306-5690)
* Kurzbio:
> Susanna-Assunta Sansone公司副主任兼牛津大学工程科学系副教授牛津大学牛津电子研究中心首席调查员。 Sie ist auch Consultant für Springer Nature und Gründer der Honorarakademie des Wissenschaftlichen Data-Journals.

* Persoche nliche 高亮：
> 待机

* Weitere Informationen:
> Das Motto von Susanna-Assunta Sanson lautet "Bessere Daten für bessere Wissenschaft". Mit ihrer Gruppe brillanter Forschungssoftware & Wissensingenieure erforscht und entwickelt sie Methoden und Werkzeuge, um die Datenwiederverwendung zu verbessern; Sie arbeiten für Datentransparenz, Forschungsintegrität und die Entwicklung des wissenschaftlichen Publizierens. Darüber hinaus führt sie Forschungsarbeiten durch, um die Forschung zu verbessern und gemeinsam zu arbeiten. Insbesondere ist sie bestrebt, digitale Forschungsobjekte, einschließlich Daten, Findable, Accesible, Interoperable and Reusable, FAIR, fuiders r Menschen und fuIndicators Maschinen zu machen.

### Philippe Rocca-Serra

* Rolle: Book Dash Mai 2020 Teilnehmer
* GitHub id: [proccaserra](http://github.com/proccaserra)
* ORCID: [0000-0001-9853-5668](https://orcid.org/0000-0001-9853-5668)
* Kurzbio:
> Philippe Rocce-Serra promovierte in Molekularbiologie von der UniversitaIndividuties t Bordeaux, Umzugin den Bereich der Bioinformatik nach dem Beitritt zum Microlayn Informatic Team am EMBL-EBI, Cambridge. Dort arbeitete er an der Gründung von ArrayExpress und wurde aktives Mitglied mehrerer Standardisierungsbemühungen, die darauf abzielten, die Vision für offene Daten und offene Wissenschaft zu fördern. Im Rahmen mehrerer EU-Projekte in den Bereichen Toxicogenomik und Nährstoffomik koordinierte er die Entwicklung des ISA-Projekts [1], die nun an der University of Oxford e-Research Centre weitergeführt wird.
...
Unter dem Kooperationsnamen OLS-4 for Turing _arbeitet der Turing Weg_ mit [Open Life Science (OLS)](https://openlifesci.org)zusammen, ein Programm, das Einzelpersonen und Interessengruppen in der Forschung dabei hilft, zu Botschaftern der Open Science zu werden. Dieses Programm wurde von Be<unk> 大 会<unk> nice Batut, Malvika Sharan und Yo Yehudi mitbegründet. Diese Zusammenarbeit bietet interessierten Mitgliedern aus Turing und The Turing Way Communities Schulung und Mentoring an, um dem OLS-Programm individuell oder in Teams beizutreten. Sie entwickeln Open Science Aspekte in den Projekten, an denen sie entweder bereits gearbeitet haben oder die sie in naher Zukunft entwickeln wollen.

Sie können die Projekte sehen, die an der zweiten Runde teilgenommen haben - [OLS-2](https://openlifesci.org/ols-2/projects-participants/) und die dritte Runde - [OLS-3](https://openlifesci.org/ols-3/projects-participants/). Diese Zusammenarbeit wurde mit dem Zuschuss für Turing Online Training zur Unterstützung von Turing-Projekten in der vierten Runde ([OLS-4](https://openlifesci.org/funders)) ausgezeichnet und Materialien offen im Turing-Ausbildungsnetz freigegeben.

## [远程计算项目Ressource](https://isabelbirds.github.io/Remote-Computational-Project-Resource/welcome.html)

Diese Ressource wurde von Isabel Birds während der COVID-19 Pandemie gestartet, um Studenten zu unterstützen, die kurzfristig von feuchten in entfernte Trockenlabors überführt wurden. Dieses Projekt enthält Links zu (1) allgemeinen Tutorials für den kompletten Anfänger, (2) Tutorials für spezifische Analysen oder Pipelines, (3) kostenlose Online-Lehrbücher und (4) Orte, um Hilfe zu bitten.

### Isabel Voidents gel

* Rolle: Der Mitwirkende des Turing Weges
* GitHub id: [IsabelBirds](http://github.com/IsabelBirds)
* ORCID: [0000-0001-8173-3879](https://orcid.org/0000-0001-8173-3879)
* Kurzbio:
> Isabel ist Doktorkandidat an der Universität von Leeds und arbeitet an der Zersplitterung der Funktion und der molekularen Evolution von lang nicht codierenden RNAs unter der Aufsicht von Dr. Julie Aspden, Dr. Mary J O’Connell und Dr. David Westhead. Sie hat sich für die molekulare Evolution und die Anwendung bioinformatischer Techniken während ihres Studiums interessiert. und entwickelte diese Interessen während der Durchführung von Forschungsprojekten im Labor Aspden und O’Connell.  
> Sie hat auch Erfahrung in der wissenschaftlichen Forschung aus der Perspektive der Geldgeber Während ihres Jahres in der Industrie und zahlreichen Sommerpraktika bei Yorkshire Cancer Research.

* Persoche nliche 高亮：
> Nach dem Lernen über die Turing Way wurde ich inspiriert eine Website für ein breiteres Publikum zu erstellen. Die Turing Way Tutorials haben mir geholfen, mein erstes Jupyter Buch zu erstellen, hat mir geholfen, die Website in einer Art und Weise zu erstellen, die offen für Beiträge ist, und machte den Austausch meiner Arbeit weniger beängstigend! Der Turing Way taucht auch ein paar Mal in den aufgelisteten Ressourcen auf. Das Ziel der Ressource ist es, den Start eines Rechenprojekts durch die Kuratierung von Links zu Tutorials und Online-Lehrbüchern weniger überwältigend zu machen. Hervorheben werden auch Fähigkeiten wie Dateimanagement oder effektiv um Hilfe gebeten zusammen mit unterhaltsamen Dingen wie Podcasts als Erinnerung daran, dass Forschung Spaß machen kann!
