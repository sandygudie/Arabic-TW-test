...
在 La littelecumequ'environ 28% de la litech savante est Open Access {cite}`Piwowar2018stateOA`et en 202020 plus de suffert eetecumpubliees through des canaux Open Access que les canaux d'abonnement traditionnels globalement {cite}`Dimensions2021openaccessasurpassurpass`
...
Projet _Ting Way_ par Steria 使用 CC-BY 4.0。 Zenodo版本原件。 [http://doi.org/10.5281/zenodo.5706310]（http://doi.org/10.5281/zenodo.5706310）
```
...
Publier ouvertement a également des avantages pour vous en tant qu'auteur. Votre travail est susceptible de toucher un plus grand public, ce qui signifie qu'il peut avoir un impact sociétal plus large. Les articles publies ouvertement sont egalement plus scientibles d'avair un avantage de citation {cite}`Tennant2016openaccess`
...
illustration du projet _The Turing Way_ par Scriberia. 使用 CC-BY 4.0。 Zenodo版本原件。 [http://doi.org/10.5281/zenodo.5706310]（http://doi.org/10.5281/zenodo.5706310）
```
