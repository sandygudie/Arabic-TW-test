...
De nombreux frameworks de test fournissent des fonctions permettant de comparer l'égalité des nombres à virgule flottante à une tolérance donnée. Par exemple pour le pytest du framework :
...
- Google test pour C++ : ASSERT_NEAR(val1, val2, abs_error)
- FRUIT pour Fortran: sub-regular assert_eq_double_in_range_(var1, var2, delta, message)
- JUnit pour Java : org.junit.Assert.assertEquals(双人服务, 双人重生, 双人增益)
- testthat pour R:
