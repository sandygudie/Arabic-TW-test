...
| 语言              | 格式化工具                                                                                                          |
| --------------- | -------------------------------------------------------------------------------------------------------------- |
| C/C++           | [GNUIndent](http://www.gnu.org/software/indent/), [Código Maior](http://sourceforge.net/projects/gcgreatcode/) |
| Python          | [➲](https://black.readthedocs.io), [Yapf](https://pypi.org/project/yapf/)                                      |
...
| Concusso/Concha | [Shellindent](http://www.bolthole.com/AWK.html)                                                                |
