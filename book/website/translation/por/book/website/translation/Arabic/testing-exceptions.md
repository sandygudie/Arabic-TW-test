...
(r-testting-challenges es-não-inteiro)=
...
- CPPUnUnit ├C+++: CPPUNIT_ASSERT_DOUBLES_EQUAL(├├├├├├├├├├├├├├)
- اختبار جوجل لـ C++: ASSERT_NEAR(val1, val2, abs_error)
- FRUITO £Fortran: zt_eq_double_in_range_(v1, var2, delta, mensagem)
