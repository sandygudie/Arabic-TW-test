...
Zum Beispiel [PEP8](https://www.python.org/dev/peps/pep-0008/) é que você tem uma ideia Python-Code-Stil e [ECMAScript 6](http://es6-features.org/) também é [ES6](http://es6-features.org/) que é mais uma padronização Internacional Específica Spezifikation fundida em Javascript.
...
| Jalta           | [Formato Google Java](https://github.com/google/google-java-format), [JIndent](http://www.jindent.com/)            |
| PHP             | [phpStylist](http://sourceforge.net/projects/phpstylist/)                                                          |
| Perl            | [PerlTidy](http://perltidy.sourceforge.net/)                                                                       |
| Concusso/Concha | [Shelleinzug](http://www.bolthole.com/AWK.html)                                                                    |
...
## Online Dienste zur Qualita├tskontrolle von Software
