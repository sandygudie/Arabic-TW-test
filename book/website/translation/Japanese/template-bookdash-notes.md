...
*このテンプレートは、ブックダッシュイベント中に HackMD で共有されたノートテイクと情報交換に使用できます。 アクセス権限は、すべてのユーザがノートを読み取り、すべてのユーザが編集できるように設定できます。*
...
各開発セッションでは、コワーキングコールにも使用するポモドーロ手法に従います。 [browser-based shared (cuckoo)clock](https://cuckoo.team/tw-bookdash) を使用して、時間を管理します（

(https://the-turing-way.netlify.app/community-handbook/coorking/coorking-motivation.html)) format@@1 ロンドンタイム(UTC+1)で提供されるすべての時間。 Please use this link to convert in your time zone: convert time: https://arewemeetingyet.com/london/YYYY-MM-DD/hh:mm (update DD: date, hh:mm: hours:minutes)
