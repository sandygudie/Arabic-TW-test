...
- C: CU_ASSERT_DOUBLE_EQUAL(実際の, 期待される粒子)
- C++<unk> CPPUnit: CPPUNIT_ASSERT_DOUBLES_EQUAL(expected actual al, delta)
...
- Rのテスト:
  - expect_equal(actual, expected tolerance=DELTA) - DELTA<unk> <unk> <unk> <unk> <unk> <unk>
  - expect_equal(actual, expected, scale=expected, tolerance=DELTA) - DE L T A <unk> <unk> <unk> <unk> <unk> <unk> <unk> <unk> <unk> <unk> <unk>
