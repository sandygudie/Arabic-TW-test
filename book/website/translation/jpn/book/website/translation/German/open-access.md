...
#### Gold Open Access Veroはffentlichung
...
_The Turing Way_ Projekt-Illustration von Scriberia Wird unter einer CC-BY 4.0 Lizenz verwendet. オリジナルバージョンのZenodo. [http://doi.org/10.5281/zenodo.5706310](http://doi.org/10.5281/zenodo.5706310)
```
...
_Die Turing Way_ Projekt-Illustration von Scriberia. Wird unter einer CC-BY 4.0 Lizenz verwendet. オリジナルバージョンのZenodo. [http://doi.org/10.5281/zenodo.5706310](http://doi.org/10.5281/zenodo.5706310)
```
...
Funders haben auch Maßnahmen ergriffen, indem sie selbst Verlage werden (Diamond Open Access). Plattformen wie [Open Research Europe](https://open-research-europe.ec.europa.eu/) and [Wellcome Open Research](https://wellcomeopenresearch.org/) sind Open Access Publishing-Plattformen fu<unk> r Forscher ダイ・フォン・ディ・ゼム・スピゼッレン・ゲルゲバー・フィナンツィアーツは、実際に会ったのです。 Funders betrachten dies als einen Service für ihre Grantees, der es ihnen ermöglicht, schnell und offen zu publizieren (Geldgeber decken die Kosten für die Infrastruktur und die Artikelverarbeitungskosten) und mehr Flexibilität als die Veröffentlichung in einer Zeitschrift. Diese Plattformen ermöglichen es Forschern, eine Reihe von Artikeltypen über den "traditionellen Forschungsartikel" hinaus zu publizieren B. Datennotizen, Software-Tool-Artikel, Methoden, Recherchehinweise und vieles mehr. Diese Geldgeber unterstützten Plattformen helfen auch, die Nadel zu verschieben und neue Richtlinien über die Bewertung der Forscher zu informieren, wie etwa die Abkehr von den Wirkungsfaktoren.
