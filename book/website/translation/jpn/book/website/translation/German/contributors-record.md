...
* Kurzbio:
> Ich bin fu<unk> hrend bei Tools, Practices and Systems Research Programman am Alan Teuring Institute. NeurowissenschaftenのIch habe einen Doktortitel カリフォルニア大学バークレー校とハブのメイン Postdoktorenforschung 脳のマッピングユニットdurchfuのケンブリッジのder大学でhrt. Ich bin Mozilla-Stipendiat (2016) und Fulbright Stipendiat (2007) Alumna.
...
* Kurzbio:
> Ich bin ein Mozilla Fellow (2018-) and Doktoranden an der MRC Brain Network Dynamics Unit of Oxford (2015-). Ich erhalte auch Unterstu<unk> tzung vom Programm Software Sustainability Institute Fellowship (2018) und Microsoft/Research Software England Cloud Computing Fellowship Programm (2018). Mein Studium war in Medizin an der University Oxford (2012-2015).
...
* ロール:
    * Der Teuring Way U<unk> bersetzer
...
* Kurzbio:
> Alejandro hat im 9 月 2020 Seine Doktorarbeit in Physical Geography am King's College London abgeschlossen. Derzeit arbeitet er als Postdoctoral Research Associate am Alan Turing Institute an einem Projekt mit dem Ziel, Open-Source-Toolkits und Demonstranten für Umweltdatenwissenschaft zu bauen und einzusetzen. Er trägt auch zu `Scivision`bei, ein generisches Framework für skalierbare Bildanalyse, geleitet von der Turing in Zusammenarbeit mit der Open-Source-Community.
...
* Kurzbio:
> Ich bin Forschungs-Software-Ingenieur、シェフィールド大学。 Ich bin auch ein Editor für rOpenSci, eine Gemeinschaft von Benutzern und Entwicklern, Schaffung einer technischen Infrastruktur für Peer-Review-R-Software-Tools für die Zusammenarbeit mit wissenschaftlichen Datenquellen im Internet.
...
* Kurzbio:
> Ich bin Doktorand am King's College London(beaufsichtigt von Petroula Proitsi & Marcus Richards教授)と、学生はアラン・チューリング研究所です。 Mein Doktorandenprojekt zielt darauf ab, frühe Mechanismen und biologische Marker von Demenz zu identifizieren, und ich arbeite derzeit auch am DECOVID Projekt am Institut.
...
* ロール: コア・ミトウィレンダー (2018 - 2019)
* GitHub id: [r-j-arnold](http://github.com/r-j-arnold)
* ORCID: [0000-0003-0355-0617](https://orcid.org/0000-0003-0355-0617)
* Kurzbio:
> Ich bin Doktorand der University of Sheffield und maache Computersimulationen von Sternbilderregionen. Ich bin Mitglied des Software-Nachhaltigkeitsinstituts 2018 und benutze die Mittel, um Vorträge und Workshops zu verschiedenen Themen im Zusammenhang mit guter Programmierpraxis zu organisieren.
...
* Kurzbio:
> Ich bin Research Data Scientistはアラン・チューリング研究所です。 Ich habe an der University<unk> Paris Diderot promoviert, wo ich am ATLAS-Experiment am Large Hadron Collider in CERN arbeitette. Während meiner Doktorarbeit habe ich an der Entdeckung der Higgs Boson-Partikel teilgenommen, die 2012 von CERN angekündigt wurde. Ich arbeitete weiter an ATLAS als Postdoc an der Uppsala Universität, wo ich mich auf die Suche nach Physik jenseits des Standardmodells der Teilchenphysik konzentrierte. Vor meinem Eintritt in die Turing war ich als Data Scientist im EdTech-Sektor tätig und habe innovative Produkte entwickelt, die sich auf den Bewertungsprozess in der Ausbildung konzentrieren. Zusammenarbeit mit Forschern des Global Systems Instituteのダーゼイットは、持続可能な開発のためのエキスナメンスデータサイエンス大学です。 In diesem Projekt verwenden wir Fernerkundung, um die Widerstandsfähigkeit der gemusterten Vegetation von halbtrockenen Trockenökosystemen in der Sahel zu überwachen.
...
* Kurzbio: Ich bin Forschungsmitglied und Community Manager von DECOVID am Alan Turing Institute. Ich bin auch Postdoktorin im Bereich der Umwelt-Archäologie und Paläoekologie. パラのIch habe einen Doktortitel in Pala<unk> kologie am 考古学研究所, University College London. Ich führe ein Projekt zur Verbesserung der FAIRness von Phytolith Daten. Ich arbeite auch an einem Projekt mit Historic England über die Entwicklung neuartiger Methoden in der Phytolith Forschung für die Anwendung auf British Archaeological Rests.
...
* Nlicheのハイライト:
> Seit meinem Studienabschluss habe ich in fintech und dann in Kunstorganisationen innerhalb von Personalteams gearbeitet, bis zum Alan Turing Institut und Unterstützung der Ethik-Beratergruppe. Ich denke, mein Highlight ist, dass ich einen großen Hintergrund als Generalistin habe! Ich freue mich derzeit sehr, zusammen mit [Laura Carter](https://github.com/LauraCarter) und [Sophia Batchelor](https://github.com/BrainonSilicon) eine Gemeinschaft um den Leitfaden für ethische Forschung zu gründen! ペルソ"nliches Zitat: "研究倫理は複雑であり、2つの関連する概念は責任ある研究イノベーション(RRI)と研究の完全性です。 Je nachdem, ob wir einen RRRI-Hut oder eine Forschungs-Integritätsbrille tragen, werden wir auf verschiedene Forschungs-Ethikfragen stoßen. Aber es ist wichtig, diese beiden zu jeder Zeit zu tragen. Ich nenne das Steampunk-Forschungsethiken."
...
* Nlicheのハイライト:
> チューリングウェイを中心に、とても温かくダイナミックなコミュニティに出会えて本当に楽しかったです! Ich habe hauptsächlich dazu beigetragen, offene Pull Requests und Netzwerke mit den Community-Mitgliedern zu prüfen.
...
* Rolle: Core Contributor (2019), Book Dash February 2020 Helfer
* GitHub id: [LouiseABowler](http://github.com/LouiseABowler)
* ORCID: [0000-0002-4910-9205](https://orcid.org/0000-0002-4910-9205)
* Kurzbio:
> Ich bin Research Data Scientist in der Research Engineering Group des Alan Turing Institute. PhysikのIch habe einen Abschluss in Physikam Imperial College London, danach traat ich in das Life Sciences Interface Doktorausbildungszentrum der University Oxford ein. Ich arbeitete an einem interdisziplinären Doktorandenprojekt, das mathematische Modellierung, Herzphysiologie und Sicherheits-Pharmakologie kombinierte und anschließend zur Turing überging. Seitdem habe ich an einer Reihe von Projekten gearbeitet, die synthetische Daten, Datenvisualisierung und natürlich den Turing Way umfassen!
...
* Rolle: コアコントリビューター、JupyterBook Infrastructure Maintainer (2020), OLS-2 チューリングメンター, Book Dash 2020 Teilnehmer und Helfer
...
* Kurzbio:
> Ich bin Research Data Edinburgh's Digital Curation Centre(英国)大学スピーツィリスト。 Ich bin Mitglied des Ausschusses für Software-Nachhaltigkeitsinstitut Fellow und HiddenREF. Von 2016 bis 2019 arbeitete ich als Research Repository アドバイザーバーミンガム大学. Von 2012 bis 2016 Ich habe bei CERN als Doktorand für Open Research gearbeitet und habe dann die Doktorarbeit aufgegeben und mit all den Fähigkeiten, die ich erworben habe, einen echten Job gestartet.
...
* ロール: Googleのドキュメントシーズン: Technical Writer, [OLS-2 fu<unk> r Teuring Projetleiter](https://github.com/alan-turing-institute/the-turing-way/tree/main/open-life-science-mentoring)(2020)
...
* ロール: コアコントリビューター(2019年)、ブックダッシュマイ2019ファシリター
* GitHub id: [rainsworth](http://github.com/rainsworth)
* ORCID: [0000-0003-2591-9462](https://orcid.org/0000-0003-2591-9462)
* Kurzbio:
> Ich bin Leiter der Research Software Community am Software Sustainability Institute. Zuvor arbeitete ich als Research Associate and Open Science Champion am Jodrell Bank Center for Astrophysics an der Manchester. Meine Forschungen betrafen die Beobachtung von Jets junger Sterne mit Funkteleskopen der nächsten Generation, um die physikalischen Prozesse zu untersuchen, die Sterne wie unsere Sonne zusammenbringen. und ich arbeite derzeit daran, Daten aus den Funkteleskopanlagen bei der Jodrell Bank für alle zugänglicher zu machen. Ich bin auch ein FOSTER zertifizierter Open Science Trainer, Mozilla Open Leader und Organisatorin für die Frauen in der Datentreffengruppe HER+Data MCR.
...
* ロール: OLS-2 fu<unk> r チューリングメンター, ブックダッシュ2020 11月 Teilnehmer
...
* ロール: HacktoberFest Spendenfo<unk> rder, [OLS Projektleiter](https://github.com/alan-turing-institute/the-turing-way/tree/main/open-life-science-mentoring) (2020), Book Dash2020 November 2020 Teilnehmer
* GitHub id: [BrainonSilicon](https://github.com/BrainonSilicon)
* ORCID: [0000-0002-8572-2058](https://orcid.org/0000-0002-8572-2058)
* Kurzbio:
> Ich bin Doktorand der University of Leeds, die Sensorimotor Lernen mit dem Center for Immersive Technologies studiert. Meine Forschung konzentriert sich darauf, zu verstehen, wie unser Gehirn interpretiert, und reagiert sowohl auf unsere physische Realität als auch auf eine konstruierte Realität (AR/VR). Ich tue dies durch eine tiefe Liebe zum Gehirn und den aufstrebenden Technologien. Wir werden in der Zukunft existieren, die wir jetzt erarbeiten; Wenn wir also mit einer "Menschen zuerst" (oder einem Gehirn zuerst) Philosophie bauen, bauen wir am Ende einen Raum auf, der es den Menschen ermöglicht, zu gedeihen.
...
<td align="center"><a href="http://beckigreen.netlify.app"><img src="https://avatars.githubusercontent.com/u/77735779?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Becki Grün</b></sub></a><br /><a href="#ideas-beckigreen" title="Ideas, Planning, & Feedback">🤔</a> <a href="#content-beckigreen" title="Content">🖋</a></td>
<td align="center"><a href="https://github.com/r-j-arnold"><img src="https://avatars1.githubusercontent.com/u/20441134?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Becky Arnold</b></sub></a><br /><a href="#question-r-j-arnold" title="Answering Questions">:speech_ballon:</a> <a href="https://github.com/alan-turing-institute/the-turing-way/commits?author=r-j-arnold" title="Code">💻</a> <a href="https://github.com/alan-turing-institute/the-turing-way/commits?author=r-j-arnold" title="Documentation">📖</a> <a href="#ideas-r-j-arnold" title="Ideas, Planning, & Feedback">🤔</a> <a href="https://github.com/alan-turing-institute/the-turing-way/pulls?q=is%3Apr+reviewed-by%3Ar-j-arnold" title="Reviewed Pull Requests">👀</a></td>
...
<td align="center"><a href="https://github.com/GeorgiaHCA"><img src="https://avatars1.githubusercontent.com/u/46889966?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Georgien</b></sub></a><br /><a href="#ideas-GeorgiaHCA" title="Ideas, Planning, & Feedback">🤔</a></td>
...
## [ニーダーランドeサイエンスセンター](https://www.esciencecenter.nl/)
...
* Kurzbio:
> Susanna-Assunta Sansonist アソシエイト・ディレクター Oxford e-Research Centerとオクスフォード大学工学部准教授。 Sie ist auch Consultant für Springer Nature und Gründer der Honorarakademie des Wissenschaftlichen Data-Journals.

* Nlicheのハイライト:
> TBA

* Weitere Informationen:
> Das Motto von Susanna-Assunta Sanson lautet "Bessere Daten für bessere Wissenschaft". Mit ihrer Gruppe brillanter Forschungssoftware & Wissensingenieure erforscht und entwickelt sie Methoden und Werkzeuge, um die Datenwiederverwendung zu verbessern; Sie arbeiten für Datentransparenz, Forschungsintegrität und die Entwicklung des wissenschaftlichen Publizierens. Darüber hinaus führt sie Forschungsarbeiten durch, um die Forschung zu verbessern und gemeinsam zu arbeiten. 以下のデータを読み込むことができます: Forschungsobjekte, einschließlich Daten, Findable, Accessible, Interoperable and Reusable, FAIR, fu<unk> r Menschen and fu<unk> r Maschinen zu machen.
...
## [リモート計算プロジェクト レスソース](https://isabelbirds.github.io/Remote-Computational-Project-Resource/welcome.html)
