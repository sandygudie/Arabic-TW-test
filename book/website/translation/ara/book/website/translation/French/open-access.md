...
على العرض الخاص بـ 28% من القمامة السافنة المفتوحة الوصول {cite}`Piwowar2018stateofOA`و2020 بالإضافة إلى طلعات جوية على e<unk> te<unk> publie<unk> es عن طريق الكانو فتح الوصول إلى تقاليد العولمة {cite}`الأبعاد 2021openaccesssurpasses`
...
مثال لتوضيح المشروع - تورينغ واي_ بار سكريبيريا. ترخيص الاستخدام CC-BY 4.0. الإصدار الأصلي على Zenodo. [http://doi.org/10.5281/zenodo.5706310] (http://doi.org/10.5281/zenodo.5706310)
```

(r-open-access-pourquoi)=
...
Publier ouvertement a également des avantages pour vous en tant qu'auteur. Votre travail est susceptible de toucher un plus grand public, ce qui signifie qu'il peut avoir un impact sociétal plus large. مقالات عامة مأخوذة من الباقة e<unk> galement بالإضافة إلى القابلية للاغتيال أفقية من الاقتباس {cite}`Tennant2016openaccess`.
...
illustration du projet _The Turing Way_ par Scriberia. ترخيص الاستخدام CC-BY 4.0. الإصدار الأصلي على Zenodo. [http://doi.org/10.5281/zenodo.5706310] (http://doi.org/10.5281/zenodo.5706310)
```
