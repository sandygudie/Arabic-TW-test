...
このチェックリストには多くの項目が含まれています。 As {ref}`mentioned before<rr-testing-write-tests>`, it is far better to do some of the items than none of them. このタスクのリストが乗り越えられないようであれば、落胆しないでください。
