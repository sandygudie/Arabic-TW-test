(qualita<unk> du code-rr)=
# Qualite<unk> du Code

| Pré-requis                                                                                        | Bedeutung |
| -------------------------------------------------------------------------------------------------- | --------- |
| [Expérience avec la ligne de commande](https://programminghistorian.org/en/lessons/intro-to-bash) | Nützlich  |
...
## Statisches Analysieren des Codes
...
(rr-code-qualite<unk> -avantages)=
### Statistiken zur Codeanalyse
...
| Lange         | Auswertungen von Code statisch                                                                                               |
| ------------- | ---------------------------------------------------------------------------------------------------------------------------- |
...
| Obus / Frappe | [Shell steuern](https://www.shellcheck.net)                                                                                  |
