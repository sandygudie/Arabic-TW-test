...
- CPPUnit für C++: CPPUNT_ASSERT_DOUBLES_EQUAL(<unk> <unk> , aktuell, Delta)
- C++<unk> <unk> <unk>：ASSERT_NEAR(val1, val2, Abwesenheit)
- FRUIT für Fortran: Subreguläre assert_eq_double_in_range_(var1, var2, delta, message)
- JUnit für Java : org.junit.Assert.assertEquals(<unk> <unk> <unk> <unk> <unk> ー<unk> <unk> <unk> <unk> <unk> <unk> )
- 测试为 R：
