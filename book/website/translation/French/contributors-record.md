...
* Rôle : Mainteneur de l'infrastructure (2018 - 2019)
...
* Rôle : Tableau de bord du livre 2021 participant
...
* Rôle : [membre du Comité de Code de Conduite](https://the-turing-way.netlify.app/community-handbook/coc/coc-enforcement.html) (2018 - présent)
...
* Rôle : Responsable de projet de recherche, Outils, Pratiques & Programmes de systèmes, Tableau de bord de mai 2021 Comité d'organisation
* GitHub id: [Arielle-Bennett](http://github.com/Arielle-Bennett)
* ORCID : https://orcid.org/0000-0002-0154-2982

* Bio court :
> Je suis le responsable du projet de recherche pour le programme Outils, Pratiques & Systèmes de l'Institut Alan Turing, un rôle essentiel dans l’infrastructure de recherche qui assure une mise en œuvre harmonieuse de collaborations, d’initiatives complexes et d’une stratégie globale de programme. Le programme est axé sur le développement et le renforcement du changement culturel, des outils de recherche, et les connaissances nécessaires pour soutenir le travail open source, multidisciplinaire dans la science des données et au-delà. J'ai travaillé dans des rôles d'infrastructure de recherche depuis l'obtention d'un BA en sciences naturelles, ce qui a permis une vaste compréhension de l'ensemble de l'écosystème complexe de l'édition de la recherche, du démarrage, de la communauté et de la gestion de projets. À la suite de ma bourse d'engagement communautaire en 2019 avec le Centre de collaboration scientifique & Engagement communautaire, Je suis un membre actif de la communauté CSCCE, siégeant sur leur Comité de Code de Conduite et organisant la Diversité, Equity & Inclusion Groupe d'Intérêt Spécial.

* Points forts personnels:
> Avant de participer à la Voie Turing, je ne savais pas quelle était la demande de tirage au sort, je ne savais pas comment en faire une ! Maintenant j'ai contribué à plusieurs parties différentes des cinq guides, y compris corédiger les chapitres initiaux sur l'activisme [pour les chercheurs](https://the-turing-way.netlify.app/ethical-research/activism.html) et des présentations données sur le sujet lors de conférences. J'encadre également d'autres contributeurs de la communauté sur la façon de créer des demandes d'ajout, de contribuer aux chapitres existants, de revoir le travail des autres et de rédiger de nouvelles idées. Le tableau de bord du livre de mai 2021 a été une occasion incroyable de s'impliquer auprès de la communauté et de s'enthousiasmer à nouveau à propos du projet! Je suis sorti de ce sentiment d'enthousiasme et de fierté des contributions que les gens ont apportées avec mon soutien - il sera brillant de voir comment elles évoluent au cours des prochains mois dans le contenu et les chapitres.

* Devis personnel:
> Le tableau de bord du livre est une expérience incroyable pour les membres les plus récents et les plus établis de la communauté. C'est un travail joyeux que de consacrer du temps à développer du contenu pour la voie Turing et à aider des gens du monde entier à y contribuer. J'ai eu la chance de participer et de jouer un rôle plus important dans le cadre du comité organisateur.
...
* Rôle : Tableau de bord du mois de novembre 2020 participant
* ORCID: [0000-0002-3905-2751](https://orcid.org/my-orcid)
* Bio court :
> Je suis le fondateur de R-Ladies en Arabie Saoudite (Dammam). J'ai commencé par majorer en pharmacologie mais j'ai rapidement développé un intérêt pour la biochimie, la biologie structurelle et la bioinformatique. J'aime apprendre en profondeur pour répondre à des questions biologiques.

* Points forts personnels:
> Je suis actuellement en train de développer un chapitre sur les "services CI". J'ai aidé à mettre à jour l'infrastructure du livre Jupyter et à ajouter [hypothèses.is](https://web.hypothes.is/) pour activer l'annotation collaborative des chapitres _The Turing Way_. J'ai également traduit le chapitre README.me en arabe. Citation personnelle: "J'ai du mal à exprimer mes pensées personnelles et mes sentiments en paroles. Ce fut une expérience extraordinaire. Cela m'a aidé à développer mes compétences techniques. Merci beaucoup à tous ceux que j'ai rencontrés dans cet événement de tableau de bord du livre :heart:.
...
* Rôle : Contributeur principal (2018 - 2019)
...
* Rôle : Book Dash May 2019 Participant, Translation Lead - Spanish (2020)
...
* Rôle : Contributeur principal (2020), Tableau de bord Février 2020 participant
...
* Rôle : Contributeur principal (2020), [OLS-2 pour la direction du projet Turing](https://github.com/alan-turing-institute/the-turing-way/tree/main/open-life-science-mentoring), Dash du livre du participant de novembre 2020
* GitHub id: [Ismael-KG](https://github.com/Ismael-KG)
* Bio court :
> Je suis assistant en recherche éthique à l'Institut Alan Turing. J'ai un baccalauréat en gestion des affaires et en administration et je travaille actuellement à un baccalauréat en philosophie des sciences sociales. Je suis membre associé de l’Institut Agréé du Personnel et du Développement (CIPD).

* Points forts personnels:
> Depuis mon diplôme de premier cycle, j'ai travaillé en fintech puis dans des organisations artistiques au sein d'équipes de ressources humaines, enfin rejoindre l’Institut Alan Turing et contribuer à soutenir le Groupe consultatif sur l’éthique. Je pense que mon point culminant est que j'ai une excellente expérience en tant que généraliste! Je suis actuellement vraiment ravi de travailler avec [Laura Carter](https://github.com/LauraCarter) et [Sophia Batchelor](https://github.com/BrainonSilicon) pour construire une communauté autour du Guide pour la recherche éthique ! Citation personnelle : « L'éthique de la recherche est complexe et deux concepts connexes sont la recherche responsable et l'innovation (RRI), et l'intégrité de la recherche. Selon que nous portions un chapeau RRI ou des lunettes d'intégrité de recherche, nous rencontrerons différentes questions d'éthique de la recherche. Mais il est important de porter les deux à tout moment. J'appelle cela l'éthique de la recherche Steampunk".

* Plus d'informations :
> Je suis vraiment fasciné par les discussions philosophiques sur les sciences sociales, J'aime donc la pensée de remettre en question à quoi ressemble une culture scientifique ouverte et comment y arriver!
...
* Rôle : Dash Book November 2020 Participant (BioHackathon-EU)
...
* Rôle : [OLS-2 pour la direction du projet Turing](https://github.com/alan-turing-institute/the-turing-way/tree/main/open-life-science-mentoring), Livre Dash Novembre 2020 Participant
...
* Rôle : Contributeur principal (2019), Aide du Livre de Février 2020
...
* Rôle : **Community Manager** (2019 - présent), Book Dash Mai 2019 Participant
...
* Rôle : Bookdash May 2021 Participant.
...
* Rôle : contributeur principal, mainteneur d'infrastructure JupyterBook (2020), OLS-2 pour le mentor Turing, le participant du livre Dash 2020 et l'assistant
...
* Rôle : Contributeur principal (2019 - présent)
...
* Rôle : Google Saison de la documentation : Écrivain technique, [OLS-2 pour diriger le projet Turing](https://github.com/alan-turing-institute/the-turing-way/tree/main/open-life-science-mentoring)(2020)
...
* Rôle : Contributeur principal (2019), Book Dash 2019 Participant et helper
...
* Rôle : OLS-2 pour le mentor Turing, Dash novembre 2020 Participant
...
* Rôle : Contributeur principal, Mainteneur d'infrastructure (2019 - présent), OLS-2 et OLS-3 pour le mentor Turing, Assistant Book Dash 2020
...
* Rôle : facilitateur de contribution HacktoberFest, [responsable du projet OLS](https://github.com/alan-turing-institute/the-turing-way/tree/main/open-life-science-mentoring) (2020), Dash Book Dash November 2020 Participant
...
<!---Z
## Z--->
\n(contributors-record-all)= \n# Tous les contributeurs\n \n✨En utilisant la spécification 

[all-contributors](https://allcontributors.org/) , _Le Turing Way_ reconnaît tous les contributeurs, pas seulement ceux qui poussent du code. ✨ \n(contributeurs-record-contributeurs)=
## Contributeurs
...
<td align="center"><a href="http://beckigreen.netlify.app"><img src="https://avatars.githubusercontent.com/u/77735779?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Becki Green</b></sub></a><br /><a href="#ideas-beckigreen" title="Ideas, Planning, & Feedback">:thinking_face :</a> <a href="#content-beckigreen" title="Content">🖋</a></td>
<td align="center"><a href="https://github.com/r-j-arnold"><img src="https://avatars1.githubusercontent.com/u/20441134?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Becky Arnold</b></sub></a><br /><a href="#question-r-j-arnold" title="Answering Questions">💬</a> <a href="https://github.com/alan-turing-institute/the-turing-way/commits?author=r-j-arnold" title="Code">:laptop_computer :</a> <a href="https://github.com/alan-turing-institute/the-turing-way/commits?author=r-j-arnold" title="Documentation">:open_book :</a> <a href="#ideas-r-j-arnold" title="Ideas, Planning, & Feedback">:thinking_face :</a> <a href="https://github.com/alan-turing-institute/the-turing-way/pulls?q=is%3Apr+reviewed-by%3Ar-j-arnold" title="Reviewed Pull Requests">👀</a></td>
...
<td align="center"><a href="https://github.com/GeorgiaHCA"><img src="https://avatars1.githubusercontent.com/u/46889966?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Géorgie</b></sub></a><br /><a href="#ideas-GeorgiaHCA" title="Ideas, Planning, & Feedback">🤔</a></td>
<td align="center"><a href="https://github.com/GeorgiaA"><img src="https://avatars2.githubusercontent.com/u/33513781?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Géorgie Atkinson</b></sub></a><br /><a href="#ideas-GeorgiaA" title="Ideas, Planning, & Feedback">:thinking_face :</a></td>
<td align="center"><a href="https://github.com/georgiatomova"><img src="https://avatars3.githubusercontent.com/u/17258191?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Géorgie Tomova</b></sub></a><br /><a href="#ideas-georgiatomova" title="Ideas, Planning, & Feedback">:thinking_face :</a></td>
<td align="center"><a href="https://github.com/GeorgianaElena"><img src="https://avatars0.githubusercontent.com/u/7579677?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Elena géorgienne</b></sub></a><br /><a href="https://github.com/alan-turing-institute/the-turing-way/pulls?q=is%3Apr+reviewed-by%3AGeorgianaElena" title="Reviewed Pull Requests">:yeux:</a></td>
...
<td align="center"><a href="https://www.imperial.ac.uk/ict/rcs"><img src="https://avatars3.githubusercontent.com/u/1724545?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Mark Woodbridge</b></sub></a><br /><a href="#ideas-mwoodbri" title="Ideas, Planning, & Feedback">:thinking_face :</a> <a href="#content-mwoodbri" title="Content">🖋</a></td>
...
<td align="center"><a href="https://reshamas.github.io"><img src="https://avatars0.githubusercontent.com/u/2507232?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Reshama Shaikh</b></sub></a><br /><a href="https://github.com/alan-turing-institute/the-turing-way/issues?q=author%3Areshamas" title="Bug reports">:bug :</a></td>
...
<td align="center"><a href="https://github.com/RobPrecious"><img src="https://avatars.githubusercontent.com/u/9133187?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Robert Precious</b></sub></a><br /><a href="#a11y-RobPrecious" title="Accessibility">:wheelchair_symbol :</a></td>
...
<td align="center"><a href="http://warrickball.github.io"><img src="https://avatars.githubusercontent.com/u/20858744?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Warrick Ball</b></sub></a><br /><a href="#ideas-warrickball" title="Ideas, Planning, & Feedback">:thinking_face :</a> <a href="#content-warrickball" title="Content">🖋</a></td>
...
<tr>
<td align="center"><a href="https://github.com/wjchulme"><img src="https://avatars1.githubusercontent.com/u/25637345?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Volonté Hulme</b></sub></a><br /><a href="https://github.com/alan-turing-institute/the-turing-way/commits?author=wjchulme" title="Documentation">:open_book :</a></td>
...
*La communauté Turing Way reçoit des contributions en nature de membres soutenus par leurs employeurs, projets ou organisations pour leur participation. Ces contributions sont applicables lorsqu'un ou plusieurs membres d'un projet ou d'une organisation collaborent pour construire et maintenir des ressources dans The Turing Way. Ces contributions comprennent également des projets qui s'appuient sur les ressources de Turing Way ou qui collaborent avec les membres de l'équipe de Turing Way à divers niveaux. Nous reconnaissons chacun de ces membres contributeurs individuellement et listons leurs profils sous « Organisations et projets de collaboration ».*

## [Université de technologie de Delft - Faculté des sciences appliquées](https://www.tudelft.nl/en/faculty-of-applied-sciences)

La Faculté des sciences appliquées est la plus grande de l’Université de technologie de Delft et se concentre sur la recherche de solutions innovantes à certains des problèmes de la société. Le développement des connaissances fondamentales nécessaires pour étayer les développements techniques qui peuvent être largement utilisés dans toute la société. En veillant à ce que ces connaissances puissent être partagées de manière efficace avec la société dans son ensemble. la Faculté valorise le partage des données et du code et a une [politique de gestion des données de recherche](https://www.tudelft.nl/en/library/research-data-management/r/policies/tu-delft-faculty-policies/) en place depuis 2020. Dans cet effort, les contributions de la Faculté des Sciences Appliquées se sont principalement concentrées sur le Chapitre de la Recherche Reproductible de _The Turing Way_.

### Pousse d'Esther

* Rôles :
  * Tableau de bord Février 2020
  * Comité de planification du tableau de bord du livre 2021
  * Contourneur d'appel semi-régulier
...
* Bio court :
> Je suis intendant de données à la Delft University of Technology, Faculté des sciences appliquées, aux Pays-Bas, où je soutiens les chercheurs dans leur gestion des données et dans leurs pratiques scientifiques ouvertes. Pour ma recherche de doctorat, j'ai analysé les dents humaines pour leur composition isotopique/chimique afin de dire quelque chose sur les modèles de mobilité humaine (champs de la médicolégologie, archéologie, ostéologie). À côté de Turing Way, je suis également impliqué avec d'autres équipes, comme le [Open Research Calendar](https://openresearchcalendar.org/) ([suivez le calendrier sur Twitter !](https://twitter.com/OpenResearchCal)), [IsoArcH](https://isoarch.eu/) et moi étions un mentor [OLS3](https://openlifesci.org/ols-3/)! Je suis également intéressé par tout ce qui concerne les échantillons physiques dans la recherche, et je suis coprésident du [Research Data Alliance Physical Samples Interest Group](https://www.rd-alliance.org/groups/physical-samples-and-collections-research-data-ecosystem-ig).

* Points forts personnels:
> Merci à Turing Way j'ai vraiment appris à travailler en collaboration avec GitHub. Le tiret du livre de Février 2020 a été un excellent coup de pied pour mettre en pratique et appliquer directement ces compétences. qui me permet maintenant de contribuer avec plus de confiance à d'autres projets aussi! J'ai principalement contribué au chapitre de la recherche reproductible, à la section Gestion des données de recherche. J'ai passé en revue le contenu existant et je travaille à ajouter une section sur les plans de gestion des données et comment gérer les données personnelles. J'ai également fait une affiche [The Turing Way](https://doi.org/10.5281/zenodo.4263403) que j'ai présentée lors d'une conférence. J'espère le payer à l'avance et faciliter l'apprentissage avec GitHub par le biais des ateliers The Turing Way ou The Carpentries. Je suis très reconnaissant de faire partie de cette grande communauté inclusive!

* Plus d'informations :
> Je pense que la recherche scientifique devrait être accessible à tous ceux qui voudraient apprendre et contribuer. J'espère rassembler des spécialistes de mon domaine de recherche pour établir des lignes directrices pour les données isotopiques provenant des restes humains et des lignes directrices sur la façon de traiter et de documenter les échantillons physiques. Je suis coprésident du groupe de Research Data Alliance [Échantillons et Collections physiques dans l'écosystème de données de recherche IG](https://www.rd-alliance.org/groups/physical-samples-and-collections-research-data-ecosystem-ig). N'hésitez pas à nous contacter si vous travaillez avec des échantillons physiques et que vous aimeriez vous impliquer! Je fais partie de l'équipe Open Research Calendar Team. Ceci est un calendrier que vous pouvez utiliser pour rester à jour avec les événements de recherche ouverts. ou ajoutez vos propres événements afin d'augmenter la visibilité. Rendez-vous sur le [Open Research Calendar Website](https://openresearchcalendar.github.io/) ou suivez le calendrier sur [Twitter](https://twitter.com/OpenResearchCal)!

* Devis :
> The 2021 May Book Dash a été une occasion passionnante pour moi de regarder derrière les scènes organisationnelles et de faire partie d'une équipe incroyable. La semaine elle-même a été absolument incroyable, en particulier les discussions et la session "show and tel"!

## [Centre eScience néerlandais](https://www.esciencecenter.nl/)

Le Netherlands eScience Center est le centre national néerlandais pour le développement et l'application de logiciels et de méthodes pour la communauté scientifique. Leur objectif principal est de permettre aux scientifiques ayant une expérience informatique variée d'utiliser pleinement le potentiel de l'infrastructure électronique disponible et de leur permettre de réaliser des percées scientifiques inaccessibles. Le Centre eScience des Pays-Bas est principalement financé par le Conseil national de la recherche (NWO) et l'organisation nationale d'infrastructure électronique (SURF) des Pays-Bas.

Le centre eScience néerlandais maintient [son propre guide](https://guide.esciencecenter.nl/) pour le développement de logiciels reproductibles. La focalisation du guide du centre eScience a un grand chevauchement avec _The Turing Way_ et il est donc logique d'éviter de doubler d'efforts. Le centre eScience contribue à _la voie de Turing_ dans les domaines qui sont pertinents pour le guide eScience. Le guide eScience pointe vers _La Voie Turante_ quand les informations seraient autrement dupliquées.

Les détails de chaque membre avec ses contributions ont été répertoriés par ordre alphabétique.

### Carlos Martinez Oritz

* Rôle : **Gestionnaire de la communauté**, Livre Dash Novembre 2020 participant/assistant
* GitHub id: [c-martinez](http://github.com/c-martinez)
* ORCID: [0000-0001-5565-7577](https://orcid.org/0000-0001-5565-7577)
* Bio court :
> Carlos a obtenu son doctorat en informatique à l'Université d'Exeter. Il a ensuite travaillé sur divers projets de recherche à l'Université d'Exeter et à l'Université de Plymouth. Au Centre eScience, il a travaillé comme ingénieur dans divers projets en sciences humaines numériques et en sciences de la vie, développer une expertise dans le traitement en langage naturel, les données ouvertes liées et la durabilité des logiciels. Il est également un instructeur certifié en menuiserie logicielle et participe fréquemment à l’organisation de formations.

* Points forts personnels:
> Nous prônons toujours la réutilisation des logiciels et le développement collaboratif des logiciels. J'adore que nous puissions faire la même chose pour les directives de développement de logiciels : réutiliser le contenu du guide eScience et développer avec la communauté _The Turing Way_!

* Plus d'informations :
> Je suis un fervent défenseur de l'amélioration de la qualité des logiciels. Je suis vraiment heureux que le centre eScience collabore avec _The Turing Way_ pour fournir des directives et aider à construire de meilleurs logiciels de recherche.
...
* Bio court :
> Mateusz a obtenu son master en biotechnologie avec spécialisation Biophysique, à l'Université Jagiellonienne, à Cracovie, en Pologne. En septembre 2019, Mateusz a rejoint le Centre eScience aux Pays-Bas dans le rôle d'officier de la communauté en mettant l'accent sur les communautés et la formation autour de l'ingénierie des logiciels de recherche, les meilleures pratiques du logiciel et la durabilité, et le rôle des logiciels dans la recherche ouverte et reproductible. Depuis 2015, Mateusz est impliqué dans la communauté des menuisiers, d'abord en tant qu'instructeur, ensuite collaborateur, mentor, membre du Conseil exécutif et formateur d'instructeur. Il dirige également la section néerlandaise des menuiseries et fait partie de l'équipe de base de la communauté nl-RSE.

* Points forts personnels:
> J'ai personnellement contribué à _The Turing Way_ en rédigeant des chapitres dans le guide de la recherche reproductible, a examiné les demandes d'ajout d'autres contributeurs et les contributions encadrées du Centre eScience néerlandais.

## [Livre de cuisine FAIR](https://fairplus.github.io/the-fair-cookbook/content/home.html)

FAIR Cookbook est une ressource en ligne qui aide les chercheurs et les professionnels des gestionnaires de données à rendre leurs données accessibles, accessibles, interopérables et réutilisables (FAIR). FAIRPlus Cookbook s'appuie sur le projet _The Turing Way_ et les modèles communautaires, et fournit des chapitres en tant que "recettes" selon les éléments FAIR, le type d'audience, le temps de lecture et le niveau de difficulté.

_Les membres de l'équipe de Turing Way_ et les membres du comité de rédaction du projet [](https://fairplus.github.io/the-fair-cookbook/content/recipes/boilerplate/people.html), Susanna-Assunta Sansone et Philippe Rocca-Serra collaborer pour assurer une interopérabilité entre les deux ressources et échanger des expériences en tant que développeurs de projets open source. FAIR Cookbook [contient les chapitres pertinents de _The Turing Way_](https://fairplus.github.io/the-fair-cookbook/search.html?q=turing+way). De même, _Le Turing Way_ présente le projet et fournit une histoire d'impact intitulée [From FAIR Co-Author to FAIR Doer](https://the-turing-way.netlify.app/reproducible-research/rdm/rdm-stories.html) par Susanna-Assunta Sansone (un co-chef du projet du livre de cuisine FAIR). Vous pouvez trouver plus de détails et d'arrière-plan dans le chapitre [Leveraging the Turing Way Book](https://fairplus.github.io/the-fair-cookbook/content/recipes/introduction/the-turing-way.html?highlight=turing).

### Sansone Susanna-Assunta

* Rôle : Dash mai 2019 participant
* GitHub id: [susannasansone](http://github.com/susannasansone)
* ORCID: [0000-0001-5306-5690](https://orcid.org/0000-0001-5306-5690)
* Bio court :
> Susanna-Assunta Sansone est directrice adjointe et enquêteuse principale au Centre de recherche en ligne d'Oxford, et un Professeur Associé au Département des Sciences d'Ingénierie de l'Université d'Oxford. Elle est également Consultante pour Springer Nature et Fondatrice Universitaire de la revue de données scientifiques.

* Points forts personnels:
> TBA

* Plus d'informations :
> La devise de Susanna-Assunta Sansone est "Meilleures données pour une meilleure science". Avec son groupe de brillants logiciels de recherche & ingénieurs de connaissance, elle recherche et développe des méthodes et des outils pour améliorer la réutilisation des données ; ils travaillent pour la transparence des données, l’intégrité de la recherche et l’évolution de la publication scientifique. Elle mène également de la recherche sur la recherche pour améliorer la façon dont la recherche est pratiquée et partagée. Plus précisément, elle s’efforce de faire des objets de recherche numérique, y compris des données, des données fiables, accessibles, interopérables et réutilisables, FAIR, pour les humains et pour les machines.

### Philippe Rocca-Serra

* Rôle : Dash May 2020 participant
* GitHub id: [proccaserra](http://github.com/proccaserra)
* ORCID: [0000-0001-9853-5668](https://orcid.org/0000-0001-9853-5668)
* Bio court :
> Philippe Rocca-Serra a obtenu un doctorat en biologie moléculaire de l'Université de Bordeaux, déménagement dans le domaine de la bioinformatique en rejoignant l’équipe de Microarray Informatics à l’EMBL-EBI, Cambridge. Là, en travaillant à la création d'ArrayExpress, il devient membre actif de plusieurs efforts de normalisation visant à promouvoir la vision des données ouvertes et de la science ouverte. Dans le cadre de plusieurs projets européens en toxicogénomique et nutrigénomique, il a coordonné le développement du projet ISA [1], qui se poursuit maintenant au Centre e-Research de l'Université d'Oxford.
...
Sous le nom de collaboration OLS-4 pour Turing, _The Turing Way_ collabore avec [Open Life Science (OLS)](https://openlifesci.org), un programme qui aide les individus et les parties prenantes de la recherche à devenir des ambassadeurs de la science ouverte. Ce programme est cofondé par Bérénice Batut, Malvika Sharan et Yo Yehudi. Cette collaboration offre une formation et un mentorat aux membres intéressés des communautés de Turing et de Turing Way pour rejoindre le programme OLS individuellement ou en équipe. Ils développent des aspects Open Science dans les projets sur lesquels ils ont déjà travaillé ou souhaitent développer dans un avenir proche.

Vous pouvez voir les projets qui ont participé au second tour - [OLS-2](https://openlifesci.org/ols-2/projects-participants/) et le troisième tour - [OLS-3](https://openlifesci.org/ols-3/projects-participants/). Cette collaboration a été attribuée à la bourse de formation en ligne Turing pour soutenir les projets Turing lors du quatrième round ([OLS-4](https://openlifesci.org/funders)) et partager ouvertement du matériel dans le réseau de formation Turing.

## [Ressource de projet informatique à distance](https://isabelbirds.github.io/Remote-Computational-Project-Resource/welcome.html)

Cette ressource a été lancée par Isabel Birds lors de la pandémie COVID-19 pour soutenir les élèves transférés de projets de laboratoire humide à distance et secs. Ce projet comprend des liens vers (1) des tutoriels généraux pour le débutant complet, (2) tutoriels pour des analyses ou des pipelines spécifiques, (3) manuels en ligne gratuits, et (4) lieux pour demander de l'aide.

### Oiseaux Isabel

* Rôle : Contributeur de Turing Way
* GitHub id: [IsabelBirds](http://github.com/IsabelBirds)
* ORCID: [0000-0001-8173-3879](https://orcid.org/0000-0001-8173-3879)
* Bio court :
> Isabel est un candidat de doctorat à l'Université de Leeds qui travaille à disséquer la fonction et l'évolution moléculaire des ARN longues non codées supervisées par le Dr Julie Aspden, Mary J O’Connell et David Westhead. Elle s'est intéressée à l'évolution moléculaire et aux applications des techniques bioinformatiques tout au long de son diplôme, et a développé ces intérêts lors de la réalisation de projets de recherche dans les laboratoires Aspden et O’Connell.  
> Elle a également une expérience de la recherche scientifique du point de vue des bailleurs de fonds. Elle a obtenu de nombreux stages d'été au cours de son année au sein de l'industrie de recherche sur le cancer du Yorkshire.

* Points forts personnels:
> Après avoir pris connaissance de la voie de Turing, j'ai été inspiré pour créer un site destiné à un public plus large. Les tutoriels de Turing Way m'ont aidé à mettre en place mon premier livre Jupyter, m'a aidé à créer le site d'une manière qui est ouverte aux contributions, et a rendu le partage de mon travail ouvertement moins effrayant! Le Turing Way apparaît également quelques fois dans les ressources listées. Le but de la ressource est de rendre le démarrage d'un projet de calcul moins écrasant en organisant des liens vers des tutoriels et des manuels en ligne. Des compétences telles que la gestion des fichiers ou la demande d'aide efficace sont également mises en évidence, avec des choses divertissantes comme les podcasts comme un rappel que la recherche peut être amusante!
