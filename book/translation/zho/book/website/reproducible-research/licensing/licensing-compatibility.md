...
---
名称：xtas-chardet96
alt: xtas vs. chardet 示例. 一个大的矩形代表合并工作的 xta。 一个大的矩形代表合并工作的 xta。 在这个矩形中，顶部有一个低方形，代表了由 Apache License v2 授权的 xtas Python 代码。 下面是一个包含“chardet”和“Python lib LGPLv2.1”字样的正方形。
---
