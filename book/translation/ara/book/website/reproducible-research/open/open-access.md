...
يعتبر نشر ومشاركة النتائج العلمية جزء من عمل البحث منذ إنشائه. ففي عام 1665 تم إنشاء أول مجلة علمية وتم تسميتها بالمعاملات الفلسفية، حيث تم نشر العديد من الرسائل العلمية التي تشتمل على الملاحظات والتجارب العلمية. حيث بدأ 'commercialisation' إضفاء الطابع التجاري للنشر العلمي في بداية الأربعينيات من القرن الماضي واستمر لعدة سنوات من خلال منشورات: مثل المجلات أو إجراء المؤتمرات أو الكتب، التي كانت متاحة للجمهور حيث يتم شراؤها برسوم اشتراك أو بشكل فردي.

ومع ذلك، تُبنى المعرفة الجديدة من خلال تجميع المعلومات من المنح الدراسية الحديثة ومن ثم البناء عليها. ففي مطلع القرن الحادي والعشرين ، تم تأسيس حركة Open Access [{term}`def<Open Access>`] الوصول المتاح، بشكل أساسي من خلال (Budapest Open Access Initative) مبادرة الوصول المفتوح في بودابست وإعلان (Berlin) برلين حول (Open Access) الوصول المتاح. وقد تضمن اقتباس في (Budapest Open Access) بودابست للوصول المتاح ملخص لهدف مبادرة:
> "هدفنا هو التوفير المجاني للدخول على الابحاث والتجارب العلمية على الإنترنت العام ، وبالتالي السماح لأي مستخدم بقراءة النصوص الكاملة لهذه المقالات أو تنزيلها أو نسخها أو توزيعها أو طباعتها أو البحث عنها أو الارتباط بها، بحيث يكون القيد الوحيد على الاستنساخ والتوزيع ، ويصبح الحق الوحيد للمؤلف في هذا المجال ، هو منح المؤلفين السيطرة على سلامة عملهم والحق في الاعتراف به والاستشهاد به بشكل صحيح "

حيث تشير التقديرات إلى أن حوالي 28٪ من المؤلفات العلمية هي Open Access {cite}`Piwowar2018stateofOA` وفي عام 2020 تم نشر المزيد من المخرجات من خلال قنوات الوصول المفتوح عن قنوات الاشتراك التقليدية {cite}`الأبعاد 2021openaccesssurpass`.
...
---
طرق للنشر علنا.
_توضيح مشروع طريق التورين_ من سكريبيريا. يستخدم بموجب ترخيص CC-BY 4.0. النسخة الأصلية على Zenodo. [http://doi.org/10.5281/zenodo.5706310] (http://doi.org/10.5281/zenodo.5706310)
```
...
_طريق التورين_ التوضيحي لمشروع سكريبيريا. يستخدم بموجب ترخيص CC-BY 4.0. النسخة الأصلية على Zenodo. [http://doi.org/10.5281/zenodo.5706310] (http://doi.org/10.5281/zenodo.5706310)
```
