...
You can use your ORCID to your CV/resume so that anyone can have a look at all your research outputs. يمكنك أيضًا استخدام ملف ORCID الخاص بك لإنشاء CV باستخدام \[ROpenSci package rorcid\](rorcid: https://github.com/ropensci/rorcid) كما هو مبين [هنا](https://discuss.ropensci.org/t/using-rorcid-to-generate-a-website-cv/1806).
