...
* Rôle : Tableau du livre 2021 Participant
...
* Rôle :
    * Contributeur de la traduction de Turing Way
...
* Rôle : Réserver Dash 2021 comité organisateur & participant
...
La participation d'Esther Plomp est soutenue par la Faculté des Sciences Appliquées de l'Université de Technologie de Delft. Veuillez [voir les détails](https://the-turing-way.netlify.app/afterword/contributors-record.html#esther-plomp) dans la section [Organisations et projets collaboratifs](https://the-turing-way.netlify.app/afterword/contributors-record.html#delft-university-of-technology-faculty-of-applied-sciences).
