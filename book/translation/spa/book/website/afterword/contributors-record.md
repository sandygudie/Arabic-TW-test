...
# All Contributors\n
✨Using [all-contributors](https://allcontributors.org/) specification, _The Turing Way_ recognises all contributors, not just the ones who push code. ✨ (contributors-record-contributors)=
## Contributors
...
This project follows the [all-contributors](https://github.com/all-contributors/all-contributors) specification. Contributions of any kind welcome! (contributors-record-collaborators)=
